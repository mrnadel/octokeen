...
/**
 * Chrome for the public, signed-out content pages: `/learn` and `/about`.
 *
 * Deliberately outside the `(app)` route group: that layout is a client
 * component that reads the session, so a crawler sees it mid-resolution.
 * Everything here is a server component, which is what puts the header links,
 * the prose and the footer in the initial HTML.
 */
