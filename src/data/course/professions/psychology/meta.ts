...
export const psychologyCourseMeta: Unit[] = [
  ...
  // ─── Section 16: Neuroscience Deep Dive ─────────────────────

  { id: 'psy-sec16-u1', title: 'Brain Architecture', description: 'The brain has specialized regions that work together.', color: '#14B8A6', icon: '🧠', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u1-L1', title: 'Cortical Lobes', description: 'Four lobes with distinct functions.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u1-L2', title: 'Prefrontal Cortex', description: 'The executive of the brain.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u1-L3', title: 'Subcortical Structures', description: 'Thalamus, basal ganglia, and more.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u1-L4', title: 'Lateralization', description: 'Left and right hemispheres.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u1-L-conv', title: 'Brain Anatomy Chat', description: 'Discuss brain regions and functions.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u1-L-speed', title: 'Brain Architecture Speed Round', description: 'Rapid-fire on brain anatomy.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u2', title: 'The Limbic System', description: 'The brain\'s emotional center.', color: '#2DD4BF', icon: '💓', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u2-L1', title: 'Amygdala', description: 'Fear and emotional memories.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u2-L2', title: 'Hippocampus', description: 'Memory formation and navigation.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u2-L3', title: 'Hypothalamus', description: 'Hormones, hunger, and homeostasis.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u2-L4', title: 'Emotion-Memory Circuit', description: 'How emotions and memories intertwine.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u2-L-conv', title: 'Limbic System Chat', description: 'Explore emotional brain circuits.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u2-L-speed', title: 'Limbic Speed Round', description: 'Rapid-fire on the limbic system.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u3', title: 'Neurotransmitter Systems', description: 'Chemical messengers that shape mood, motivation, and thought.', color: '#5EEAD4', icon: '⚗️', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u3-L1', title: 'Dopamine & Serotonin', description: 'Reward, mood, and motivation.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u3-L2', title: 'GABA & Glutamate', description: 'The brain\'s brakes and accelerator.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u3-L3', title: 'Norepinephrine & Acetylcholine', description: 'Alertness, attention, and memory.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u3-L4', title: 'NT Pathways & Disorders', description: 'When neurotransmitter systems go wrong.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u3-L-conv', title: 'Neurotransmitter Chat', description: 'Discuss NT systems and mental health.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u3-L-speed', title: 'NT Speed Round', description: 'Rapid-fire on neurotransmitters.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u4', title: 'Synaptic Plasticity', description: 'The brain rewires itself with experience.', color: '#0D9488', icon: '🔌', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u4-L1', title: 'LTP & LTD', description: 'Strengthening and weakening connections.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u4-L2', title: 'Hebbian Learning', description: 'Neurons that fire together wire together.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u4-L3', title: 'Critical Periods', description: 'Windows of extreme brain plasticity.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u4-L4', title: 'Neurogenesis', description: 'Growing new neurons throughout life.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u4-L-conv', title: 'Plasticity Chat', description: 'Discuss how experience reshapes the brain.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u4-L-speed', title: 'Plasticity Speed Round', description: 'Rapid-fire on brain plasticity.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u5', title: 'Neuroimaging Methods', description: 'Modern tools let us watch the brain in action.', color: '#0F766E', icon: '🔬', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u5-L1', title: 'fMRI & PET', description: 'Seeing blood flow and metabolism.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u5-L2', title: 'EEG & MEG', description: 'Measuring electrical and magnetic signals.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u5-L3', title: 'TMS', description: 'Disrupting brain regions to test causation.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u5-L4', title: 'Limitations', description: 'What neuroimaging can and can\'t tell us.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u5-L-conv', title: 'Neuroimaging Chat', description: 'Choose the right imaging method.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u5-L-speed', title: 'Neuroimaging Speed Round', description: 'Rapid-fire on brain imaging.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u6', title: 'Hormones & Behavior', description: 'Chemical messengers that shape stress, bonding, and mood.', color: '#14B8A6', icon: '💉', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u6-L1', title: 'HPA Axis & Cortisol', description: 'The stress response system.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u6-L2', title: 'Oxytocin & Testosterone', description: 'Bonding and competition hormones.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u6-L3', title: 'Thyroid & Metabolism', description: 'How thyroid hormones affect mood and energy.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u6-L4', title: 'Feedback Loops', description: 'How the body regulates hormone levels.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u6-L-conv', title: 'Hormones Chat', description: 'Discuss hormone-behavior connections.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u6-L-speed', title: 'Hormones Speed Round', description: 'Rapid-fire on hormones.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u7', title: 'Sleep Neurophysiology', description: 'Sleep is active brain maintenance and memory filing.', color: '#2DD4BF', icon: '😴', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u7-L1', title: 'Sleep Stages', description: 'NREM and REM sleep explained.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u7-L2', title: 'Circadian Rhythms', description: 'Your body\'s internal clock.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u7-L3', title: 'Sleep & Memory', description: 'How sleep consolidates learning.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u7-L4', title: 'Sleep Disorders', description: 'When sleep goes wrong.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u7-L5', title: 'Sleep & Memory Consolidation', description: 'How the sleeping brain files memories.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u7-L-conv', title: 'Sleep Science Chat', description: 'Discuss sleep and brain function.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u7-L-speed', title: 'Sleep Speed Round', description: 'Rapid-fire on sleep.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u8', title: 'Pain & Sensation', description: 'Pain is constructed by your brain, not just detected by your body.', color: '#5EEAD4', icon: '🩹', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u8-L1', title: 'Gate Control Theory', description: 'Spinal gates can block pain signals.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u8-L2', title: 'Chronic Pain', description: 'When the brain amplifies pain without injury.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u8-L3', title: 'Phantom Limb Pain', description: 'Pain in a missing body part.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u8-L4', title: 'Pain Modulation', description: 'How the brain turns pain up or down.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u8-L-conv', title: 'Pain Science Chat', description: 'Discuss pain and the brain.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u8-L-speed', title: 'Pain Speed Round', description: 'Rapid-fire on pain science.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u9', title: 'Psychopharmacology', description: 'How psychiatric medications alter neurotransmitter systems.', color: '#0D9488', icon: '💊', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u9-L1', title: 'SSRIs & Antidepressants', description: 'First-line treatments for depression.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u9-L2', title: 'Antipsychotics', description: 'Blocking dopamine for psychosis.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u9-L3', title: 'Anxiolytics & Stimulants', description: 'GABA enhancement and dopamine boost.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u9-L4', title: 'Pharmacokinetics', description: 'How drugs move through the body.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u9-L-conv', title: 'Medication Chat', description: 'Discuss psychiatric medication decisions.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u9-L-speed', title: 'Psychopharm Speed Round', description: 'Rapid-fire on medications.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec16-u10', title: 'Brain Disorders & Damage', description: 'Damage to specific areas reveals how those areas work.', color: '#0F766E', icon: '🔍', sectionIndex: 16, sectionTitle: 'Neuroscience Deep Dive', lessons: [
    { id: 'psy-sec16-u10-L1', title: 'Lesion Studies', description: 'Damage reveals function.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u10-L2', title: 'Aphasia Types', description: 'Broca\'s and Wernicke\'s language disorders.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u10-L3', title: 'Famous Cases', description: 'Phineas Gage, H.M., and Clive Wearing.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u10-L4', title: 'Split-Brain & Agnosia', description: 'When hemispheres disconnect or recognition fails.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec16-u10-L5', title: 'Damage & Recovery', description: 'How the brain adapts after injury.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u10-L-conv', title: 'Brain Damage Chat', description: 'Analyze a neurological case.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec16-u10-L-speed', title: 'Brain Disorders Speed Round', description: 'Rapid-fire on brain damage cases.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },

  // ─── Section 17: Statistics & Methods ───────────────────────

  { id: 'psy-sec17-u1', title: 'Descriptive Statistics', description: 'Summarize data with numbers that reveal patterns.', color: '#F97316', icon: '📊', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u1-L1', title: 'Mean, Median, Mode', description: 'Three ways to find the center.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u1-L2', title: 'Standard Deviation', description: 'Measuring spread around the mean.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u1-L3', title: 'Normal Distribution', description: 'The bell curve and the 68-95-99.7 rule.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u1-L4', title: 'Z-Scores & Skewness', description: 'Standardizing and understanding shape.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u1-L-conv', title: 'Statistics Chat', description: 'Interpret descriptive stats together.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u1-L-speed', title: 'Descriptive Stats Speed Round', description: 'Rapid-fire on basic statistics.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u2', title: 'Probability & Sampling', description: 'Good research depends on representative samples.', color: '#FB923C', icon: '🎲', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u2-L1', title: 'Sampling Methods', description: 'Random, stratified, convenience, snowball.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u2-L2', title: 'Central Limit Theorem', description: 'Sample means approach normal as n increases.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u2-L3', title: 'Sampling Bias', description: 'How bad samples lead to wrong conclusions.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u2-L4', title: 'Sample Size & Margin of Error', description: 'Bigger samples mean smaller errors.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u2-L-conv', title: 'Sampling Chat', description: 'Design a sampling strategy.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u2-L-speed', title: 'Sampling Speed Round', description: 'Rapid-fire on probability and sampling.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u3', title: 'Hypothesis Testing', description: 'How scientists decide if results are real.', color: '#FDBA74', icon: '🧪', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u3-L1', title: 'Null vs Alternative', description: 'Two competing explanations.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u3-L2', title: 'P-Values & Alpha', description: 'The probability threshold for significance.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u3-L3', title: 'Type I & Type II Errors', description: 'False positives and false negatives.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u3-L4', title: 'Statistical Power', description: 'The ability to detect a real effect.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u3-L-conv', title: 'Hypothesis Testing Chat', description: 'Walk through a hypothesis test.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u3-L-speed', title: 'Hypothesis Speed Round', description: 'Rapid-fire on hypothesis testing.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u4', title: 't-Tests & ANOVA', description: 'The workhorse tests for comparing group means.', color: '#EA580C', icon: '📈', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u4-L1', title: 't-Tests', description: 'Comparing two group means.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u4-L2', title: 'One-Way ANOVA', description: 'Comparing three or more groups.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u4-L3', title: 'Post-Hoc Tests', description: 'Finding which groups differ after ANOVA.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u4-L4', title: 'Choosing the Right Test', description: 'When to use t-test vs ANOVA.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u4-L-conv', title: 'Group Comparison Chat', description: 'Choose and run the right test.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u4-L-speed', title: 't-Test & ANOVA Speed Round', description: 'Rapid-fire on comparing groups.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u5', title: 'Correlation & Regression', description: 'Measuring relationships and predicting outcomes.', color: '#C2410C', icon: '📉', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u5-L1', title: 'Pearson r', description: 'Linear correlation from -1 to +1.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u5-L2', title: 'Correlation vs Causation', description: 'The most important lesson in statistics.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u5-L3', title: 'Simple Regression', description: 'Predicting Y from X.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u5-L4', title: 'Multiple Regression', description: 'Multiple predictors and R-squared.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u5-L-conv', title: 'Correlation Chat', description: 'Spot the correlation-causation traps.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u5-L-speed', title: 'Correlation Speed Round', description: 'Rapid-fire on correlation and regression.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u6', title: 'Effect Sizes & CIs', description: 'P-values say if an effect exists. Effect sizes say if it matters.', color: '#F97316', icon: '📏', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u6-L1', title: 'Cohen\'s d', description: 'Small, medium, and large effects.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u6-L2', title: 'Confidence Intervals', description: 'The range likely to contain the true value.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u6-L3', title: 'Practical vs Statistical', description: 'Significant doesn\'t always mean important.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u6-L4', title: 'APA Reporting Standards', description: 'Effect sizes are now required.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u6-L-conv', title: 'Effect Size Chat', description: 'Evaluate research findings.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u6-L-speed', title: 'Effect Size Speed Round', description: 'Rapid-fire on effect sizes and CIs.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u7', title: 'Advanced Research Designs', description: 'Beyond simple experiments.', color: '#FB923C', icon: '🧩', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u7-L1', title: 'Factorial Designs', description: 'Two variables, main effects, interactions.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u7-L2', title: 'Longitudinal & Cross-Sectional', description: 'Following people over time vs snapshots.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u7-L3', title: 'Quasi-Experiments', description: 'When random assignment isn\'t possible.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u7-L4', title: 'Threats to Validity', description: 'What can go wrong in research.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u7-L-conv', title: 'Research Design Chat', description: 'Choose the best design for a study.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u7-L-speed', title: 'Design Speed Round', description: 'Rapid-fire on research designs.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u8', title: 'Qualitative Methods', description: 'Numbers don\'t capture everything.', color: '#FDBA74', icon: '📝', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u8-L1', title: 'Interviews & Focus Groups', description: 'Collecting rich qualitative data.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u8-L2', title: 'Thematic Analysis', description: 'Finding patterns in qualitative data.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u8-L3', title: 'Grounded Theory', description: 'Building theory from data.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u8-L4', title: 'Mixed Methods', description: 'Combining quantitative and qualitative.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u8-L-conv', title: 'Qualitative Chat', description: 'Design a qualitative study.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u8-L-speed', title: 'Qualitative Speed Round', description: 'Rapid-fire on qualitative methods.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u9', title: 'The Replication Crisis', description: 'Many famous findings don\'t replicate. Here\'s why.', color: '#EA580C', icon: '🚨', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u9-L1', title: 'The Problem', description: 'Only 39% of studies replicated.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u9-L2', title: 'P-Hacking & HARKing', description: 'How researchers game the system.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u9-L3', title: 'Publication Bias', description: 'Journals prefer positive results.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u9-L4', title: 'Open Science Solutions', description: 'Pre-registration, open data, registered reports.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u9-L-conv', title: 'Replication Chat', description: 'Evaluate a suspicious finding.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u9-L-speed', title: 'Replication Speed Round', description: 'Rapid-fire on the replication crisis.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec17-u10', title: 'Reading Research Papers', description: 'Every psychology student needs this skill.', color: '#C2410C', icon: '📖', sectionIndex: 17, sectionTitle: 'Statistics & Methods', lessons: [
    { id: 'psy-sec17-u10-L1', title: 'Paper Anatomy', description: 'Abstract, intro, methods, results, discussion.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u10-L2', title: 'Evaluating Methods', description: 'Spotting weak methodology.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u10-L3', title: 'Interpreting Statistics', description: 'Look at effect sizes, not just p-values.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u10-L4', title: 'Meta-Analysis & Evidence', description: 'The hierarchy of evidence.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec17-u10-L-conv', title: 'Paper Reading Chat', description: 'Critically read a study together.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec17-u10-L-speed', title: 'Research Literacy Speed Round', description: 'Rapid-fire on reading research.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },

  // ─── Section 18: Specialized Fields ─────────────────────────

  { id: 'psy-sec18-u1', title: 'Evolutionary Psychology', description: 'Natural selection shaped our brains.', color: '#EF4444', icon: '🦎', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u1-L1', title: 'Natural & Sexual Selection', description: 'How evolution shapes behavior.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u1-L2', title: 'Kin Selection', description: 'Why we help our relatives.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u1-L3', title: 'Evolutionary Mismatch', description: 'Ancient brains in a modern world.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u1-L4', title: 'Criticisms', description: 'Just-so stories and underestimating culture.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u1-L-conv', title: 'Evolution Chat', description: 'Debate evolutionary explanations.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u1-L-speed', title: 'Evolutionary Speed Round', description: 'Rapid-fire on evolutionary psychology.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u2', title: 'Health Psychology', description: 'Your mind affects your body.', color: '#F87171', icon: '🏥', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u2-L1', title: 'Biopsychosocial Model', description: 'Health is biology + psychology + social factors.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u2-L2', title: 'Behavior Change Models', description: 'Stages of change and why habits are hard.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u2-L3', title: 'Psychoneuroimmunology', description: 'How stress weakens your immune system.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u2-L4', title: 'Social Determinants', description: 'How SES and support affect health.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u2-L-conv', title: 'Health Psychology Chat', description: 'Discuss mind-body connections.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u2-L-speed', title: 'Health Speed Round', description: 'Rapid-fire on health psychology.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u3', title: 'Forensic Psychology', description: 'Where psychology meets the legal system.', color: '#FCA5A5', icon: '⚖️', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u3-L1', title: 'Eyewitness Reliability', description: 'Memory is more fragile than we think.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u3-L2', title: 'False Confessions', description: 'Why innocent people confess.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u3-L3', title: 'Risk Assessment', description: 'Predicting future violence.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u3-L4', title: 'Competency & Insanity', description: 'Legal standards in mental health.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u3-L-conv', title: 'Forensic Chat', description: 'Analyze a forensic psychology case.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u3-L-speed', title: 'Forensic Speed Round', description: 'Rapid-fire on forensic psychology.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u4', title: 'Clinical Assessment', description: 'How psychologists measure mental health systematically.', color: '#DC2626', icon: '📋', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u4-L1', title: 'Structured Interviews', description: 'SCID and standardized assessment.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u4-L2', title: 'Neuropsych Assessment', description: 'Testing brain function.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u4-L3', title: 'Projective vs Objective Tests', description: 'Rorschach vs MMPI-2.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u4-L4', title: 'Case Formulation', description: 'Integrating data into a treatment plan.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u4-L-conv', title: 'Assessment Chat', description: 'Build a case formulation.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u4-L-speed', title: 'Assessment Speed Round', description: 'Rapid-fire on clinical assessment.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u5', title: 'Cross-Cultural Psychology', description: 'Most psychology research comes from Western cultures.', color: '#B91C1C', icon: '🌍', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u5-L1', title: 'The WEIRD Problem', description: 'Western samples aren\'t universal.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u5-L2', title: 'Individualism-Collectivism', description: 'How culture shapes self-concept.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u5-L3', title: 'Etic vs Emic', description: 'Universal vs culture-specific approaches.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u5-L4', title: 'Cultural Adaptation', description: 'Making assessment and therapy culturally appropriate.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u5-L-conv', title: 'Cross-Cultural Chat', description: 'Discuss cultural biases in psychology.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u5-L-speed', title: 'Culture Speed Round', description: 'Rapid-fire on cross-cultural psychology.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u6', title: 'Consciousness & Mind', description: 'How does physical brain create subjective experience?', color: '#EF4444', icon: '💭', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u6-L1', title: 'Hard Problem', description: 'Why consciousness is so hard to explain.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u6-L2', title: 'Theories of Consciousness', description: 'Global workspace, IIT, and more.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u6-L3', title: 'Free Will Debate', description: 'Determinism, compatibilism, and Libet.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u6-L4', title: 'Self-Awareness', description: 'Mirror test and levels of consciousness.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u6-L-conv', title: 'Consciousness Chat', description: 'Debate the nature of mind.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u6-L-speed', title: 'Consciousness Speed Round', description: 'Rapid-fire on consciousness.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u7', title: 'Positive Psychology', description: 'Building what makes life worth living.', color: '#F87171', icon: '🌟', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u7-L1', title: 'Strengths & Flow', description: 'Character strengths and optimal experience.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u7-L2', title: 'Grit & Resilience', description: 'Persistence and bouncing back.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u7-L3', title: 'PERMA Model', description: 'Seligman\'s 5 pillars of well-being.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u7-L4', title: 'Criticisms', description: 'Toxic positivity and ignoring systemic issues.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u7-L-conv', title: 'Positive Psych Chat', description: 'Apply positive psychology principles.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u7-L-speed', title: 'Positive Psych Speed Round', description: 'Rapid-fire on positive psychology.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u8', title: 'Systems Psychology', description: 'Individual behavior happens in context.', color: '#FCA5A5', icon: '🔗', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u8-L1', title: 'Bronfenbrenner\'s Model', description: 'Nested systems from micro to macro.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u8-L2', title: 'Community Psychology', description: 'Prevention over treatment.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u8-L3', title: 'Systems Thinking', description: 'Feedback loops and unintended consequences.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u8-L4', title: 'Ecological Interventions', description: 'Changing environments, not just people.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u8-L-conv', title: 'Systems Chat', description: 'Analyze behavior in context.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u8-L-speed', title: 'Systems Speed Round', description: 'Rapid-fire on systems psychology.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u9', title: 'Psychology & Technology', description: 'Technology is changing how we think, feel, and connect.', color: '#DC2626', icon: '💻', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u9-L1', title: 'Digital Mental Health', description: 'Therapy apps and teletherapy.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u9-L2', title: 'Social Media Effects', description: 'What the research actually shows.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u9-L3', title: 'Attention & Technology', description: 'The multitasking myth.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u9-L4', title: 'Digital Ethics', description: 'Privacy, consent, and AI in psychology.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u9-L-conv', title: 'Tech & Psych Chat', description: 'Evaluate digital mental health tools.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u9-L-speed', title: 'Technology Speed Round', description: 'Rapid-fire on psychology and technology.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
  { id: 'psy-sec18-u10', title: 'Ethics in Psychology', description: 'Ethical practice protects everyone.', color: '#B91C1C', icon: '📜', sectionIndex: 18, sectionTitle: 'Specialized Fields', lessons: [
    { id: 'psy-sec18-u10-L1', title: 'APA Ethics Code', description: 'Five core principles.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u10-L2', title: 'Informed Consent', description: 'Voluntary, competent, and informed.', icon: '📝', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u10-L3', title: 'Confidentiality Limits', description: 'When you must break confidentiality.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u10-L4', title: 'Ethical Dilemmas', description: 'When principles conflict.', icon: '📝', xpReward: 25, questions: [] },
    { id: 'psy-sec18-u10-L-conv', title: 'Ethics Chat', description: 'Navigate an ethical dilemma.', icon: '💬', type: 'conversation', xpReward: 20, questions: [] },
    { id: 'psy-sec18-u10-L-speed', title: 'Ethics Speed Round', description: 'Rapid-fire on psychological ethics.', icon: '⚡', type: 'speed-round', xpReward: 20, questions: [] },
  ] },
];
