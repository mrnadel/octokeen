...
export const lesson3: Lesson = {
  ...
  questions: [
    {
      id: 'htw-L3-T1',
      type: 'teaching',
      question: 'Engineering in your home',
      explanation: 'Door hinges are pin joints, toilets use float-valve feedback control, and your washing machine is a vibration isolation problem. Every household item applies fundamental engineering principles.',
      hint: 'Look for forces, energy flows, and control systems in everyday objects.',
    },
    {
      id: 'htw-L3-T2',
      type: 'teaching',
      question: 'Torque and mechanical advantage at home',
      explanation: 'A wrench, a door handle, and a bottle opener all use torque (force times lever arm) to amplify your effort. Longer lever arms require less force to produce the same torque.',
      hint: 'Door handles are placed far from the hinge to maximize your mechanical advantage.',
    },
    ...
    },
    {
      id: 'htw-L3-Q2',
      type: 'multiple-choice',
      question: 'A hydraulic door closer exerts a closing torque of 8 NÂ·m. If the door handle is 0.9 m from the hinge, what minimum force must you apply at the handle to hold the door open?',
      options: [
        'About 4.5 N',
        'About 7.2 N',
        'About 8.9 N',
  ...
  <text x="27" y="28" font-size="4.5" fill="#334155" font-style="italic">Ï„</text>
  <!-- Labels -->
  <text x="40" y="74" font-size="4" fill="#6B7280" text-anchor="middle">Torque = F Ã— d</text>
</svg>`,
      correctIndex: 2,
      explanation: 'Torque = Force Ã— distance. To balance 8 NÂ·m at 0.9 m: F = 8 / 0.9 â‰ˆ 8.9 N. This is a direct application of moment equilibrium about the hinge axis - the same principle used to size actuators and select motors.',
      distractorExplanations: {
      ...
      hint: 'Rearrange Ï„ = F Ã— d to solve for F.',
    },
    // --- TOILET FLUSH ---
    {
      id: 'htw-L3-Q3',
  ...
  <polygon points="18,50 16,53 20,53" fill="#6B7280"/>
    ...
    },
    {
      ...
      options: [
        'Monostable (single-rest) mechanism',
        'Bistable (over-center) mechanism',
        'Astable (free-running) oscillator',
        'Critically damped linear mechanism',
      ],
    ...
    // --- WASHING MACHINE ---
    {
      ...
      options: [
        'Gravitational force pulling the water downward through the perforations',
        'Centrifugal effect - water\'s inertia carries it radially outward as the drum spins',
        'Vacuum suction created at the drum center drawing water inward then out',
        'Electromagnetic force from the motor field repelling the water molecules',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none">
  <rect x="2" y="2" width="76" height="76" rx="8" fill="#58CC02" opacity="0.06"/>
  <!-- Outer drum circle -->
  ...
  <text x="40" y="74" font-size="4" fill="#6B7280" text-anchor="middle">centrifugal direction</text>
    ...
    },
    {
      ...
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><line x1="10" y1="60" x2="72" y2="60" stroke="#3B8700" stroke-width="1.5"/><line x1="10" y1="60" x2="10" y2="8" stroke="#3B8700" stroke-width="1.5"/><text x="6" y="34" font-size="3.5" fill="#334155" transform="rotate(-90 6 34)">Amp</text><text x="42" y="68" font-size="3.5" fill="#334155">RPM</text><path d="M12,58 C20,56 28,50 35,15 C38,8 42,8 45,15 C52,50 60,56 68,58" stroke="#58CC02" stroke-width="2.5" fill="none"/><line x1="40" y1="60" x2="40" y2="10" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="2 1.5"/><text x="40" y="7" text-anchor="middle" font-size="3.5" fill="#58CC02">resonance</text><text x="40" y="76" text-anchor="middle" font-size="3.5" fill="#6B7280">Ï‰_spin = Ï‰_natural</text></svg>`,
      correctAnswer: true,
    ...
    // --- STAIRS/FLOORS ---
    {
      ...
      options: [
        'A concentrated point load applied at the center of the floor span',
        'A uniformly distributed load (UDL) spread over the floor area',
        'A moment couple applied at the floor edges by the walls',
        'An axial compressive load transmitted along the floor joists',
      ],
    ...
    },
    {
      ...
      options: [
        'Deflection beyond L/360 causes immediate structural collapse of the floor',
        'Excessive deflection causes cracking in finishes, visible sagging, and discomfort',
        'L/360 is the yield point deflection for all standard structural steel beams',
        'Deflection limits exist only for aesthetic reasons with no functional significance',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><line x1="10" y1="30" x2="70" y2="30" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="2 1.5"/><line x1="10" y1="30" x2="10" y2="50" stroke="#3B8700" stroke-width="2"/><line x1="70" y1="30" x2="70" y2="50" stroke="#3B8700" stroke-width="2"/><path d="M10,30 Q40,45 70,30" stroke="#58CC02" stroke-width="2.5" fill="none"/><line x1="40" y1="30" x2="40" y2="38" stroke="#334155" stroke-width="1" stroke-dasharray="1 1"/><text x="44" y="38" font-size="4" fill="#334155" font-style="italic">Î´</text><line x1="10" y1="54" x2="70" y2="54" stroke="#6B7280" stroke-width="1" stroke-dasharray="2 1"/><text x="40" y="52" text-anchor="middle" font-size="3.5" fill="#6B7280" font-style="italic">L</text><text x="40" y="64" text-anchor="middle" font-size="4" fill="#334155">Î´_max â‰¤ L/360</text><text x="40" y="72" text-anchor="middle" font-size="3.5" fill="#6B7280">Serviceability, not strength</text></svg>`,
      correctIndex: 1,
    ...
    },
    {
      ...
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="10" y="18" width="25" height="36" rx="3" stroke="#3B8700" stroke-width="1.5" fill="#A5E86C" fill-opacity="0.1"/><text x="22" y="32" text-anchor="middle" font-size="3.5" fill="#334155">Single</text><text x="22" y="40" text-anchor="middle" font-size="4" fill="#3B8700">U = 5.8</text><text x="22" y="48" text-anchor="middle" font-size="3" fill="#6B7280">poor</text><rect x="45" y="18" width="25" height="36" rx="3" stroke="#58CC02" stroke-width="1.5" fill="#58CC02" fill-opacity="0.1"/><text x="57" y="32" text-anchor="middle" font-size="3.5" fill="#334155">Double</text><text x="57" y="40" text-anchor="middle" font-size="4" fill="#58CC02">U = 1.2</text><text x="57" y="48" text-anchor="middle" font-size="3" fill="#6B7280">better</text><text x="40" y="64" text-anchor="middle" font-size="4" fill="#334155">Lower U â†’ less heat loss</text><text x="40" y="72" text-anchor="middle" font-size="3.5" fill="#6B7280">U = 1/R (W/mÂ²Â·K)</text></svg>`,
      correctAnswer: true,
      explanation: 'U-value (overall heat transfer coefficient, W/mÂ²Â·K) represents total heat flow per unit area per degree of temperature difference. Lower U-value = less heat transfer = better insulation. This is the reciprocal of total thermal resistance (R-value). Engineers use U-values to calculate building heat loads and select HVAC equipment - the same thermal resistance network analysis used in electronics cooling.',
      distractorExplanations: {
        1: 'U-value (overall heat transfer coefficient, W/mÂ²Â·K) represents total heat flow per unit area per degree of temperature difference.',
      },
    },
    // --- MORE DOOR / HINGE ---
    {
...
export const lesson4: Lesson = {
  ...
  questions: [
    {
      id: 'htw-L4-T1',
      type: 'teaching',
      question: 'Leverage and mechanical advantage',
      explanation: 'Most hand tools are levers or wedges that multiply your input force. A longer wrench handle reduces the force needed because torque = force times lever arm.',
      hint: 'A cheater pipe doubles the handle length, halving the required force.',
    },
    {
      id: 'htw-L4-T2',
      type: 'teaching',
      question: 'Hydraulic systems in the workshop',
      explanation: 'Hydraulic jacks use Pascal\'s law: pressure applied anywhere in a confined fluid transmits equally everywhere. A small pump piston can lift heavy loads through a large output piston.',
      hint: 'The mechanical advantage equals the ratio of output piston area to input piston area.',
    },
    // --- WRENCH / SPANNER ---
    {
      id: 'htw-L4-Q1',
      type: 'multiple-choice',
      question: 'A bolt requires 60 NÂ·m of torque to loosen. You have a wrench that is 0.3 m long but cannot generate enough force. Adding a "cheater pipe" extends the handle to 0.6 m. By what factor does the required hand force decrease?',
      options: [
  ...
  <text x="64" y="31" font-size="3" fill="#58CC02" text-anchor="middle">cheater</text>
    ...
    // --- POWER DRILL ---
    {
      ...
      options: [
        'Torque decreases proportionally with the speed reduction',
        'Torque remains unchanged regardless of the RPM setting',
        'Torque increases, since power equals torque times speed',
        'Torque becomes zero because the bit stalls at low RPM',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><line x1="12" y1="65" x2="12" y2="8" stroke="#3B8700" stroke-width="1.5"/><line x1="12" y1="65" x2="72" y2="65" stroke="#3B8700" stroke-width="1.5"/><text x="6" y="38" font-size="4" fill="#334155" transform="rotate(-90 6 38)">Ï„</text><text x="42" y="74" font-size="4" fill="#334155">Ï‰</text><path d="M16,14 C22,18 35,40 65,58" stroke="#58CC02" stroke-width="2.5" fill="none"/><text x="40" y="30" text-anchor="middle" font-size="4" fill="#334155">P = Ï„Ï‰ = const</text><text x="20" y="20" font-size="3.5" fill="#58CC02">high Ï„</text><text x="56" y="54" font-size="3.5" fill="#6B7280">low Ï„</text><text x="18" y="60" font-size="3" fill="#6B7280">low Ï‰</text><text x="60" y="64" font-size="3" fill="#6B7280">high Ï‰</text></svg>`,
      correctIndex: 2,
      explanation: 'Power = Torque Ã— angular velocity (P = Ï„Ï‰). At constant power, reducing Ï‰ increases Ï„ proportionally. This is why drills have low-speed/high-torque settings for large holes or hard materials and high-speed/low-torque settings for small holes in soft materials. The same P = Ï„Ï‰ relationship governs gearbox design in vehicles and industrial machinery.',
      distractorExplanations: {
      ...
      hint: 'Rearrange the power equation: Ï„ = P / Ï‰.',
    },
    {
      id: 'htw-L4-Q4',
      type: 'fill-blank',
    ...
    // --- HYDRAULIC JACK ---
    {
      id: 'htw-L4-Q5',
      type: 'multiple-choice',
      question: 'A hydraulic jack has a small piston of area 5 cmÂ² and a large piston of area 50 cmÂ². If you apply 100 N of force to the small piston, what force does the large piston exert?',
      options: [
  ...
  <text x="40" y="73" font-size="4" fill="#334155" text-anchor="middle">P = F&#x2081;/A&#x2081; = F&#x2082;/A&#x2082;</text>
      ...
      correctIndex: 2,
      explanation: 'Pascal\'s law states that pressure is transmitted uniformly in an enclosed fluid. Pressure = 100 N / 5 cmÂ² = 20 N/cmÂ². Force on large piston = 20 N/cmÂ² Ã— 50 cmÂ² = 1,000 N. The mechanical advantage is the area ratio (50/5 = 10Ã—). However, the small piston must travel 10Ã— farther - energy is conserved, not force.',
      distractorExplanations: {
    ...
    },
    {
      ...
      options: [
        'Oil has a lower viscosity than air, reducing friction losses',
        'Oil is nearly incompressible, transmitting pressure without loss',
  ...
  <text x="40" y="73" font-size="4" fill="#334155" text-anchor="middle">1st-class lever</text>
    ...
    // --- SCREWDRIVER ---
    {
      ...
      options: [
        'The larger handle weighs more, providing greater rotational inertia',
        'A larger diameter gives a longer moment arm, increasing torque',
        'The larger handle reduces friction within the screw threads',
        'The larger handle increases the rotational speed of the screw',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><circle cx="22" cy="32" r="6" stroke="#6B7280" stroke-width="1.5" fill="#6B7280" fill-opacity="0.1"/><line x1="22" y1="38" x2="22" y2="56" stroke="#6B7280" stroke-width="2"/><text x="22" y="16" text-anchor="middle" font-size="3.5" fill="#6B7280">small r</text><text x="22" y="22" text-anchor="middle" font-size="3.5" fill="#6B7280">low Ï„</text><circle cx="58" cy="32" r="12" stroke="#58CC02" stroke-width="2" fill="#58CC02" fill-opacity="0.1"/><line x1="58" y1="44" x2="58" y2="56" stroke="#3B8700" stroke-width="2"/><text x="58" y="14" text-anchor="middle" font-size="3.5" fill="#58CC02">large R</text><text x="58" y="22" text-anchor="middle" font-size="3.5" fill="#58CC02">high Ï„</text><line x1="22" y1="32" x2="28" y2="32" stroke="#6B7280" stroke-width="1" stroke-dasharray="1 1"/><text x="25" y="30" font-size="3" fill="#6B7280">r</text><line x1="58" y1="32" x2="70" y2="32" stroke="#58CC02" stroke-width="1" stroke-dasharray="1 1"/><text x="64" y="30" font-size="3" fill="#58CC02">R</text><text x="40" y="68" text-anchor="middle" font-size="4" fill="#334155">Ï„ = F Ã— r</text><text x="40" y="76" text-anchor="middle" font-size="3.5" fill="#6B7280">Bigger handle â†’ more torque</text></svg>`,
      correctIndex: 1,
      explanation: 'Torque = Force Ã— radius. A larger handle radius means more torque is transmitted to the screw for the same grip force. This is why stubby screwdrivers (short but fat handles) and T-handle drivers exist - they maximize the moment arm. The same principle explains why steering wheels, valve handwheels, and capstan mechanisms use large diameters.',
      distractorExplanations: {
    ...
    },
    {
      ...
      options: [
        'Require less torque to drive and generate less holding force',
        'Advance faster per turn but provide lower axial holding force',
        'Advance less per turn but generate higher axial force per torque',
        'Have identical mechanical advantage since the diameter is the same',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="12" y="18" width="8" height="40" rx="1" stroke="#3B8700" stroke-width="1.5" fill="#A5E86C" fill-opacity="0.1"/><line x1="8" y1="22" x2="24" y2="22" stroke="#3B8700" stroke-width="1"/><line x1="8" y1="30" x2="24" y2="30" stroke="#3B8700" stroke-width="1"/><line x1="8" y1="38" x2="24" y2="38" stroke="#3B8700" stroke-width="1"/><line x1="8" y1="46" x2="24" y2="46" stroke="#3B8700" stroke-width="1"/><line x1="8" y1="54" x2="24" y2="54" stroke="#3B8700" stroke-width="1"/><text x="16" y="14" text-anchor="middle" font-size="3.5" fill="#6B7280">Coarse</text><rect x="48" y="18" width="8" height="40" rx="1" stroke="#58CC02" stroke-width="1.5" fill="#58CC02" fill-opacity="0.1"/><line x1="44" y1="21" x2="60" y2="21" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="25" x2="60" y2="25" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="29" x2="60" y2="29" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="33" x2="60" y2="33" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="37" x2="60" y2="37" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="41" x2="60" y2="41" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="45" x2="60" y2="45" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="49" x2="60" y2="49" stroke="#58CC02" stroke-width="1"/><line x1="44" y1="53" x2="60" y2="53" stroke="#58CC02" stroke-width="1"/><text x="52" y="14" text-anchor="middle" font-size="3.5" fill="#58CC02">Fine</text><text x="16" y="64" text-anchor="middle" font-size="3" fill="#6B7280">fast, low F</text><text x="52" y="64" text-anchor="middle" font-size="3" fill="#58CC02">slow, high F</text><text x="40" y="76" text-anchor="middle" font-size="3.5" fill="#334155">Finer pitch â†’ higher MA</text></svg>`,
      correctIndex: 2,
      explanation: 'A finer pitch means less linear advance per revolution, which increases the mechanical advantage (MA = 2Ï€r / pitch). For the same input torque, a finer thread generates more axial (clamping) force. The trade-off: more turns are needed to drive the screw to the same depth. This is directly analogous to gear ratios - lower "gear" means more force but slower motion.',
      distractorExplanations: {
