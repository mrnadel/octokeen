  ...
  questions: [
    {
      id: 'htw-L5-T1',
      type: 'teaching',
      question: 'Engineering in sports equipment',
      explanation: 'Every piece of sports equipment is an engineering design. Bicycles use gear ratios to trade speed for torque, and helmets use energy-absorbing foam to reduce impact forces.',
      hint: 'A higher gear ratio means more wheel rotations per pedal stroke but more force required.',
    },
    {
      id: 'htw-L5-T2',
      type: 'teaching',
      question: 'Energy and momentum in sports',
      explanation: 'A roller coaster converts potential energy to kinetic energy and back. Impact sports like baseball and golf rely on momentum transfer and the coefficient of restitution.',
      hint: 'The "sweet spot" on a bat is the center of percussion, where no reaction force is felt at the handle.',
    },
    // â”€â”€ BICYCLE â”€â”€
    {
      id: 'htw-L5-Q1',
    ...
    },
    {
      ...
      options: [
        'Under load, spokes lose tension but never go slack - a slack spoke would buckle',
        'Pretension strengthens each spoke by work-hardening the wire material',
        'It prevents the rim from expanding outward due to centrifugal force at speed',
    ...
    {
      id: 'htw-L5-Q4',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><circle cx="22" cy="40" r="10" stroke="#3B8700" stroke-width="1.5" fill="none"/><circle cx="58" cy="40" r="5" stroke="#3B8700" stroke-width="1.5" fill="none"/><line x1="22" y1="30" x2="58" y2="35" stroke="#58CC02" stroke-width="2.5"/><line x1="22" y1="50" x2="58" y2="45" stroke="#A5E86C" stroke-width="1" stroke-dasharray="2 2"/><text x="40" y="28" text-anchor="middle" font-size="4" fill="#58CC02" font-weight="bold">Tight side (Tâ‚)</text><text x="40" y="58" text-anchor="middle" font-size="4" fill="#A5E86C">Slack side (Tâ‚‚)</text><path d="M32 29 L38 28" stroke="#58CC02" stroke-width="1.5" marker-end="url(#a54)"/><path d="M48 47 L42 48" stroke="#A5E86C" stroke-width="1" marker-end="url(#a54b)"/><defs><marker id="a54" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#58CC02"/></marker><marker id="a54b" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#A5E86C"/></marker></defs><animateTransform attributeName="transform" type="rotate" from="0 22 40" to="360 22 40" dur="3s" repeatCount="indefinite"/><text x="40" y="70" text-anchor="middle" font-size="5" fill="#334155" font-weight="bold">Chain Drive</text><text x="40" y="77" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">Tâ‚ &gt; Tâ‚‚</text></svg>`,
      type: 'fill-blank',
    ...
    // â”€â”€ TENNIS/BADMINTON RACKET â”€â”€
    {
      id: 'htw-L5-Q5',
      ...
      options: [
        'The sweet spot is at a vibration node - no impulse reaches the hand',
        'The sweet spot is where the frame is thickest and most rigid',
        'The sweet spot is where string density is highest for max force',
        'The sweet spot is psychological - all points transmit equal vibration',
      ],
      correctIndex: 0,
    ...
    {
      id: 'htw-L5-Q6',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="10" y="28" width="25" height="30" rx="2" fill="#A5E86C" opacity="0.15" stroke="#A5E86C" stroke-width="1"/><text x="22" y="40" text-anchor="middle" font-size="3.5" fill="#A5E86C" font-weight="bold">Wood</text><text x="22" y="46" text-anchor="middle" font-size="3" fill="#334155">E/Ï = 16</text><text x="22" y="52" text-anchor="middle" font-size="3" fill="#334155">GPaÂ·mÂ³/kg</text><rect x="45" y="20" width="25" height="38" rx="2" fill="#58CC02" opacity="0.15" stroke="#58CC02" stroke-width="1.5"/><text x="57" y="34" text-anchor="middle" font-size="3.5" fill="#58CC02" font-weight="bold">CFRP</text><text x="57" y="40" text-anchor="middle" font-size="3" fill="#334155">E/Ï = 140</text><text x="57" y="46" text-anchor="middle" font-size="3" fill="#334155">GPaÂ·mÂ³/kg</text><line x1="57" y1="50" x2="57" y2="55" stroke="#3B8700" stroke-width="1"/><text x="57" y="53" text-anchor="middle" font-size="2.5" fill="#3B8700">~9Ã— stiffer</text><path d="M38 38 L42 38" stroke="#334155" stroke-width="1" marker-end="url(#a56)"/><defs><marker id="a56" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#334155"/></marker></defs><text x="40" y="12" text-anchor="middle" font-size="5" fill="#334155" font-weight="bold">Specific Stiffness</text><text x="40" y="72" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">E/Ï (stiffness per kg)</text></svg>`,
      type: 'multiple-choice',
      question: 'Modern tennis rackets use carbon fiber composites instead of wood. What is the primary engineering advantage?',
      options: [
        'Much higher specific stiffness - stiffer yet lighter frame',
        'Carbon fiber is cheaper than wood for mass production',
        'Carbon fiber eliminates all vibration during impact',
    ...
    // â”€â”€ SKATEBOARD / ROLLER COASTER â”€â”€
    {
      id: 'htw-L5-Q7',
      type: 'multiple-choice',
      ...
      options: [
        'Centripetal acceleration must be at least g, i.e. vÂ²/r â‰¥ g at the top',
        ...
        'The car\'s weight must exceed the centripetal force at all speeds',
      ],
      correctIndex: 0,
      explanation: 'At the top of the loop, both gravity and the normal force point toward the center. The minimum case is when the normal force equals zero: mg = mvÂ²/r, so vÂ² = gr. If v is less than sqrt(gr), the car loses contact. This is why roller coaster loops are often clothoid (teardrop) shaped - the smaller radius at the top requires less speed.',
      distractorExplanations: {
    ...
    },
    {
      ...
      correctAnswer: true,
      explanation: 'Conservation of energy: mgh = Â½mvÂ². The speed at the bottom depends only on the height difference, not the path taken (assuming no friction or drag). This is a direct consequence of gravity being a conservative force. The track shape affects the time to reach the bottom, but not the final speed.',
      distractorExplanations: {
        1: 'Conservation of energy: mgh = Â½mvÂ².',
      },
    },
    {
      id: 'htw-L5-Q9',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><path d="M10 25 Q10 60 40 60 Q70 60 70 25" stroke="#3B8700" stroke-width="2" fill="none"/><circle cx="40" cy="56" r="3" fill="#334155"/><line x1="40" y1="53" x2="40" y2="46" stroke="#58CC02" stroke-width="1.5"/><path d="M38 47 L40 44 L42 47" fill="#58CC02"/><text x="45" y="47" font-size="3.5" fill="#58CC02" font-weight="bold">N</text><line x1="40" y1="59" x2="40" y2="66" stroke="#334155" stroke-width="1.5"/><path d="M38 65 L40 68 L42 65" fill="#334155"/><text x="45" y="66" font-size="3.5" fill="#334155" font-style="italic">mg</text><path d="M40 56 Q40 40 40 36" stroke="#A5E86C" stroke-width="0.8" stroke-dasharray="2 1"/><text x="45" y="38" font-size="3" fill="#A5E86C">to center</text><text x="40" y="12" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Half-Pipe</text><text x="40" y="76" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">N = m(g + vÂ²/r)</text></svg>`,
      type: 'multiple-choice',
      question: 'When a skateboarder rides through a curved half-pipe, they feel "heavier" at the bottom of the curve. Why?',
      options: [
        'Normal force must provide both centripetal acceleration and support weight, exceeding mg',
        'Gravity increases at the bottom of curved surfaces due to geometric effects',
        'The skateboard deck compresses, adding a spring force on top of rider weight',
        'Air pressure is measurably higher at the bottom of the enclosed half-pipe',
      ],
      correctIndex: 0,
      explanation: 'At the bottom of a curve, the net upward force must equal the centripetal force: N - mg = mvÂ²/r, so N = m(g + vÂ²/r). The normal force exceeds the rider\'s weight, creating the sensation of feeling heavier. This is the same principle that makes you feel heavy at the bottom of a roller coaster loop.',
      distractorExplanations: {
    ...
    // â”€â”€ DIVING BOARD â”€â”€
    {
      ...
      options: [
        'A cantilever beam - max bending stress at the fixed support end',
        'A simply supported beam - max stress at the center of the span',
        'A column under compression - max stress at mid-height buckling',
        'A truss member - stress is distributed uniformly along its length',
      ],
      correctIndex: 0,
      explanation: 'A diving board is fixed at one end and free at the other - a cantilever. The bending moment is greatest at the fixed support (M = F Ã— L for a point load at the tip). This is why diving boards are thicker/reinforced at the base and taper toward the free end.',
      distractorExplanations: {
    ...
    },
    {
      ...
      explanation: 'The diver excites the board\'s natural frequency (determined by its stiffness and mass). A bent beam stores elastic potential energy (U = Â½kxÂ²), which converts to kinetic energy as the board springs back, launching the diver upward.',
    },
    // â”€â”€ HELMET â”€â”€
    {
      id: 'htw-L5-Q12',
      ...
      options: [
        'The foam increases stopping time, reducing peak force (impulse-momentum theorem)',
        'The foam reflects impact energy back outward like a compressed spring',
        'The foam is stronger than skull bone, so it absorbs the entire force',
        'The foam prevents the helmet shell from cracking by distributing stress',
      ],
      correctIndex: 0,
      explanation: 'The impulse-momentum theorem states FÂ·Î”t = mÎ”v. For a given change in momentum (fixed mÎ”v), increasing the stopping time Î”t (by foam crushing) reduces the peak force F on the head. The foam absorbs energy through irreversible plastic deformation - it crushes and does not bounce back, which is why helmets must be replaced after an impact.',
      distractorExplanations: {
    ...
    {
      id: 'htw-L5-Q13',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="10" y="25" width="25" height="18" rx="2" fill="#A5E86C" opacity="0.3" stroke="#A5E86C" stroke-width="1"/><text x="22" y="32" text-anchor="middle" font-size="3" fill="#A5E86C" font-weight="bold">EPS foam</text><text x="22" y="38" text-anchor="middle" font-size="3" fill="#334155">plastic</text><rect x="10" y="45" width="25" height="10" rx="2" fill="#A5E86C" opacity="0.15" stroke="#A5E86C" stroke-width="0.5" stroke-dasharray="2 1"/><text x="22" y="52" text-anchor="middle" font-size="2.5" fill="#334155">crushed</text><text x="38" y="36" font-size="6" fill="#334155">â‰ </text><rect x="45" y="25" width="25" height="18" rx="2" fill="#58CC02" opacity="0.2" stroke="#58CC02" stroke-width="1"/><text x="57" y="32" text-anchor="middle" font-size="3" fill="#58CC02" font-weight="bold">Rubber</text><text x="57" y="38" text-anchor="middle" font-size="3" fill="#334155">elastic</text><path d="M57 45 Q54 50 57 55 Q60 50 57 45" stroke="#58CC02" stroke-width="1" fill="none"><animate attributeName="d" values="M57 45 Q54 50 57 55 Q60 50 57 45;M57 45 Q52 50 57 57 Q62 50 57 45;M57 45 Q54 50 57 55 Q60 50 57 45" dur="1s" repeatCount="indefinite"/></path><text x="57" y="62" text-anchor="middle" font-size="2.5" fill="#334155">bounces back</text><text x="40" y="12" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Foam Deformation</text><text x="40" y="74" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">plastic crush absorbs energy</text></svg>`,
      type: 'true-false',
    ...
    // â”€â”€ SWIMMING / ROWING â”€â”€
    {
      ...
      options: [
        'Skin friction drag - reducing roughness lowers the shear stress on the body',
        'Wave drag - shaving prevents the body from creating surface waves',
        'Induced drag - smooth skin reduces the trailing vortices behind the swimmer',
        'Compressibility drag - smooth surfaces reduce shock wave formation in water',
      ],
      correctIndex: 0,
    ...
    {
      id: 'htw-L5-Q15',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><ellipse cx="30" cy="35" rx="14" ry="8" fill="#58CC02" opacity="0.1" stroke="#3B8700" stroke-width="1"/><text x="30" y="37" text-anchor="middle" font-size="3" fill="#3B8700">streamlined</text><circle cx="30" cy="58" r="7" fill="#A5E86C" opacity="0.15" stroke="#A5E86C" stroke-width="1"/><text x="30" y="60" text-anchor="middle" font-size="3" fill="#A5E86C">bluff</text><path d="M44 35 Q55 30 65 35 Q55 40 65 38" stroke="#334155" stroke-width="0.5" fill="none"/><path d="M37 58 Q48 52 58 55 Q50 62 60 58" stroke="#334155" stroke-width="0.5" fill="none"/><text x="60" y="32" font-size="3" fill="#334155">thin wake</text><text x="60" y="53" font-size="3" fill="#334155">wide wake</text><text x="40" y="12" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Pressure Drag</text><text x="40" y="75" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">Re ~ 10â¶ â†’ turbulent flow</text></svg>`,
      type: 'fill-blank',
      question: 'The Reynolds number for a swimmer is approximately 10â¶, indicating the flow is _____. Streamlining the body profile primarily reduces _____ drag.',
      blanks: ['turbulent', 'pressure'],
      wordBank: ['turbulent', 'laminar', 'pressure', 'friction', 'wave'],
      explanation: 'At Re ~ 10â¶, flow around a human body is fully turbulent. Streamlining (reducing the projected frontal area and making the body shape more hydrodynamic) primarily reduces pressure drag (also called form drag), which results from the pressure difference between the front and rear of the body.',
    },
    // â”€â”€ GOLF CLUB â”€â”€
    {
      id: 'htw-L5-Q16',
      ...
      options: [
        'Higher moment of inertia, making the club more forgiving on off-center hits',
        'A larger face increases air resistance, slowing the swing for better control',
        'Titanium is heavier than steel, so the larger head generates more impact force',
        'The larger head stores more elastic energy due to titanium\'s lower Young\'s modulus',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        'The ratio of separation speed to approach speed - it measures kinetic energy conservation',
        'The ratio of ball weight to club head weight at the point of impact',
        'The friction coefficient between the ball cover and the club face surface',
        'The percentage of the ball volume that deforms plastically during impact',
      ],
      correctIndex: 0,
    ...
    // â”€â”€ MIXED / CROSS-TOPIC â”€â”€
    {
      ...
      explanation: 'A clothoid (or Euler spiral / teardrop) loop has a smaller radius at the top and a larger radius at the bottom. The smaller radius at the top means vÂ²/r can equal g at a lower speed, so the coaster does not need as much speed (and therefore height) to maintain contact at the top. This also reduces the g-forces at the bottom, improving rider comfort.',
    },
    {
      id: 'htw-L5-Q20',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><path d="M12 42 Q20 38 40 38 Q60 38 68 42 L65 44 Q55 40 40 40 Q25 40 15 44 Z" fill="#3B8700" opacity="0.2" stroke="#3B8700" stroke-width="1"/><line x1="68" y1="42" x2="75" y2="42" stroke="#58CC02" stroke-width="1.5" marker-end="url(#a520)"/><text x="74" y="39" font-size="3.5" fill="#58CC02">v</text><line x1="12" y1="42" x2="5" y2="42" stroke="#334155" stroke-width="1" marker-end="url(#a520b)"/><text x="3" y="39" font-size="3" fill="#334155">D</text><defs><marker id="a520" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#58CC02"/></marker><marker id="a520b" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#334155"/></marker></defs><line x1="20" y1="50" x2="20" y2="65" stroke="#334155" stroke-width="0.5"/><line x1="60" y1="50" x2="60" y2="65" stroke="#334155" stroke-width="0.5"/><text x="40" y="60" text-anchor="middle" font-size="3.5" fill="#334155">P = CvÂ³</text><text x="40" y="12" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Drag vs Power</text><text x="40" y="75" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">2Ã—P â†’ 2^(1/3) Ã— v â‰ˆ 1.26v</text></svg>`,
      type: 'multiple-choice',
      question: 'A rowing team wants to maximize boat speed. The drag force on the hull is proportional to vÂ². If they double their combined power output, by what factor does the steady-state speed increase?',
      options: [
        '2^(1/3) â‰ˆ 1.26 - because power = drag Ã— velocity = CvÂ³',
        '2 - double power means double speed at steady state',
        'âˆš2 â‰ˆ 1.41 - because drag force scales with vÂ²',
        '4 - because power is proportional to vâ´ for boats',
      ],
      correctIndex: 0,
      explanation: 'At steady state, Power = Drag Ã— Velocity. If drag = CvÂ², then P = CvÂ³. So v = (P/C)^(1/3). Doubling P gives v_new = (2P/C)^(1/3) = 2^(1/3) Ã— v_old â‰ˆ 1.26v. This cube-root relationship explains why enormous power increases yield modest speed gains in water sports.',
      distractorExplanations: {
      ...
      hint: 'At steady state, all power goes to overcoming drag. Write P = F_drag Ã— v and substitute F_drag = CvÂ².',
    },
  ],
};
  ...
  questions: [
    {
      id: 'htw-L6-T1',
      type: 'teaching',
      question: 'Engineering in structures',
      explanation: 'Buildings, bridges, and dams all resist forces through structural engineering principles. Every beam, cable, and column is sized to handle specific loads with an appropriate safety factor.',
      hint: 'Structural engineers balance strength, stiffness, and stability against weight and cost.',
    },
    {
      id: 'htw-L6-T2',
      type: 'teaching',
      question: 'Elevators and counterweights',
      explanation: 'Elevators use counterweights to balance the cab weight, so the motor only lifts the difference between cab load and counterweight. This dramatically reduces the required motor power.',
      hint: 'The counterweight typically equals the cab weight plus 40% of maximum passenger load.',
    },
    // â”€â”€ ELEVATOR â”€â”€
    {
      id: 'htw-L6-Q1',
      ...
      options: [
        'Elevators run empty more often than full - 40% balances the average load for minimum',
        '50% would make the system perfectly balanced and the motor would have nothing to do',
        '40% is a building code safety regulation with no engineering justification behind it',
        'The extra 10% of counterweight mass is reserved to account for cable weight',
      ],
      correctIndex: 0,
    ...
    {
      id: 'htw-L6-Q2',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="12" y="35" width="18" height="16" rx="2" fill="#58CC02" opacity="0.2" stroke="#3B8700" stroke-width="1"/><text x="21" y="45" text-anchor="middle" font-size="3.5" fill="#334155" font-weight="bold">2000kg</text><rect x="52" y="25" width="14" height="12" rx="1" fill="#3B8700" opacity="0.2" stroke="#3B8700" stroke-width="1"/><text x="59" y="33" text-anchor="middle" font-size="3" fill="#334155">1500kg</text><ellipse cx="40" cy="14" rx="6" ry="3" stroke="#334155" stroke-width="1" fill="none"/><line x1="21" y1="35" x2="34" y2="14" stroke="#334155" stroke-width="1"/><line x1="46" y1="14" x2="59" y2="25" stroke="#334155" stroke-width="1"/><path d="M21 51 L21 58" stroke="#58CC02" stroke-width="1.5"/><path d="M19 56 L21 60 L23 56" fill="#58CC02"/><text x="28" y="58" font-size="3" fill="#58CC02">a=1.5</text><text x="40" y="68" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">F = Î”mg + (mâ‚+mâ‚‚)a</text><text x="40" y="75" text-anchor="middle" font-size="3.5" fill="#58CC02" font-weight="bold">â‰ˆ 10,155 N</text></svg>`,
      type: 'multiple-choice',
      question: 'An elevator cable supports a 2000 kg cab with a 1500 kg counterweight. When the cab accelerates upward at 1.5 m/sÂ², what is the net force the motor must provide?',
      options: [
        '(2000âˆ’1500)Ã—g + (2000+1500)Ã—1.5 = 10,155 N - gravity imbalance plus total inertia',
        '2000 Ã— 9.81 = 19,620 N - the full weight of the cab without counterweight',
        '(2000 âˆ’ 1500) Ã— 9.81 = 4,905 N - only the net gravitational weight difference',
        '2000 Ã— 1.5 = 3,000 N - only the acceleration force acting on the cab',
      ],
      correctIndex: 0,
      explanation: 'The motor must overcome: (1) the net gravitational imbalance = (m_cab âˆ’ m_cw) Ã— g = 500 Ã— 9.81 = 4905 N, plus (2) the inertia of both masses (cab going up + counterweight going down, both accelerating) = (m_cab + m_cw) Ã— a = 3500 Ã— 1.5 = 5250 N. Total â‰ˆ 10,155 N. Both masses are connected by the cable, so the motor must accelerate both.',
      distractorExplanations: {
    ...
    // â”€â”€ BRIDGE TYPES â”€â”€
    {
      ...
      options: [
        'Top chord in compression, bottom chord in tension - how a truss resists bending',
        'Both chords carry compression; diagonal web members carry all the tension',
        'Top chord in tension, bottom chord in compression - the truss hangs from above',
        'All truss members carry identical forces regardless of their position',
      ],
      correctIndex: 0,
    ...
    {
      id: 'htw-L6-Q8',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="30" y="8" width="20" height="14" rx="2" fill="#58CC02" opacity="0.15" stroke="#3B8700" stroke-width="1.5"/><line x1="38" y1="22" x2="38" y2="58" stroke="#3B8700" stroke-width="1"/><rect x="50" y="54" width="18" height="12" rx="2" stroke="#334155" stroke-width="1" fill="none"/><line x1="38" y1="58" x2="50" y2="58" stroke="#3B8700" stroke-width="1"/><text x="40" y="17" text-anchor="middle" font-size="3.5" fill="#58CC02" font-weight="bold">water</text><line x1="22" y1="15" x2="22" y2="58" stroke="#334155" stroke-width="0.5" stroke-dasharray="2 2"/><text x="19" y="38" font-size="3.5" fill="#334155" transform="rotate(-90 19 38)">40 m</text><line x1="20" y1="15" x2="24" y2="15" stroke="#334155" stroke-width="0.5"/><line x1="20" y1="58" x2="24" y2="58" stroke="#334155" stroke-width="0.5"/><text x="59" y="62" text-anchor="middle" font-size="3" fill="#334155">house</text><circle cx="68" cy="58" r="1.5" fill="#58CC02"><animate attributeName="r" values="1;2;1" dur="1s" repeatCount="indefinite"/></circle><text x="40" y="72" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">P = Ïgh â‰ˆ 392 kPa</text></svg>`,
      type: 'multiple-choice',
      question: 'A water tower provides water pressure to a town. If the water surface is 40 m above a house\'s faucet, what is the approximate water pressure at the faucet (Ï_water = 1000 kg/mÂ³)?',
      options: [
        'About 392 kPa (57 psi) - from P = Ïgh with the given values',
        'About 40 kPa - pressure numerically equals the height in kPa',
        'About 4000 kPa - from the modified formula P = ÏgÂ²h',
        'It depends on the pipe diameter, not the elevation height',
      ],
      correctIndex: 0,
      explanation: 'Hydrostatic pressure P = Ïgh = 1000 Ã— 9.81 Ã— 40 = 392,400 Pa â‰ˆ 392 kPa â‰ˆ 57 psi. This is the "head" concept - height of fluid creates pressure at the bottom. Water towers use gravity to provide consistent pressure without pumps, as long as the water level is maintained. Pipe diameter affects flow rate, not static pressure.',
      distractorExplanations: {
    ...
    {
      id: 'htw-L6-Q9',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="15" y="12" width="16" height="20" rx="2" fill="#58CC02" opacity="0.15" stroke="#3B8700" stroke-width="1"/><text x="23" y="24" text-anchor="middle" font-size="3.5" fill="#3B8700">mgh</text><path d="M35 22 L45 22" stroke="#334155" stroke-width="1.5" marker-end="url(#a69)"/><defs><marker id="a69" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#334155"/></marker></defs><rect x="49" y="12" width="16" height="20" rx="2" fill="#A5E86C" opacity="0.15" stroke="#A5E86C" stroke-width="1"/><text x="57" y="24" text-anchor="middle" font-size="3.5" fill="#A5E86C">P=Ïgh</text><text x="23" y="40" text-anchor="middle" font-size="3" fill="#334155">PE</text><text x="57" y="40" text-anchor="middle" font-size="3" fill="#334155">pressure</text><text x="40" y="55" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Energy Conversion</text><text x="40" y="65" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">gravitational PE â†’ pressure energy</text></svg>`,
      type: 'fill-blank',
      ...
      explanation: 'Water stored at elevation has gravitational potential energy (mgh). When a faucet opens, this potential energy converts to pressure energy (P = Ïgh) that drives flow. This is the basis of the "hydraulic head" concept used throughout civil and mechanical engineering. No pump is needed during peak demand - the elevated water provides pressure passively.',
    },
    // â”€â”€ HVAC DUCTWORK â”€â”€
    {
      id: 'htw-L6-Q10',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="8" y="22" width="30" height="18" rx="9" fill="#3B8700" opacity="0.1" stroke="#3B8700" stroke-width="1.5"/><text x="23" y="33" text-anchor="middle" font-size="3.5" fill="#3B8700">D=30cm</text><rect x="8" y="48" width="30" height="10" rx="5" fill="#A5E86C" opacity="0.15" stroke="#A5E86C" stroke-width="1.5"/><text x="23" y="55" text-anchor="middle" font-size="3.5" fill="#A5E86C">D=20cm</text><text x="55" y="33" font-size="3.5" fill="#3B8700">Î”P = 1Ã—</text><text x="55" y="55" font-size="3.5" fill="#A5E86C" font-weight="bold">Î”P â‰ˆ 7.6Ã—</text><path d="M42 31 L48 31" stroke="#3B8700" stroke-width="0.8" marker-end="url(#a610)"/><path d="M42 53 L48 53" stroke="#A5E86C" stroke-width="0.8" marker-end="url(#a610b)"/><defs><marker id="a610" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#3B8700"/></marker><marker id="a610b" markerWidth="4" markerHeight="4" refX="2" refY="2" orient="auto"><path d="M0,0 L4,2 L0,4Z" fill="#A5E86C"/></marker></defs><text x="40" y="12" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Duct Sizing</text><text x="40" y="72" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">Î”P âˆ 1/Dâµ</text></svg>`,
      type: 'multiple-choice',
      ...
      options: [
        'The smaller duct has roughly (30/20)âµ â‰ˆ 7.6Ã— more pressure drop - it scales as',
        'The smaller duct has 50% more pressure drop - proportional to the diameter ratio',
        'Both ducts have the same pressure drop since the delivered airflow is identical',
        'The larger duct has higher pressure drop because air moves slower and lingers longer',
      ],
      correctIndex: 0,
      explanation: 'For fully developed turbulent flow in a pipe, the Darcy-Weisbach equation gives Î”P âˆ QÂ²/(Dâµ) at constant flow rate Q. Reducing diameter from 30 to 20 cm increases Î”P by (30/20)âµ = (1.5)âµ â‰ˆ 7.6Ã—. This is why duct sizing is critical in HVAC - slightly undersized ducts cause enormous pressure drop increases, demanding larger, more expensive fans.',
      distractorExplanations: {
    ...
    },
    {
      ...
      options: [
        'It depends on both Reynolds number and relative wall roughness (Moody chart)',
        'It is constant at 0.02 for all turbulent flows regardless of conditions',
        'It equals 64/Re, the same formula used for laminar flow calculations',
        'It is zero for turbulent flow because mixing eliminates wall shear stress',
      ],
      correctIndex: 0,
      explanation: 'In turbulent flow, the Colebrook equation (or Moody chart) determines the friction factor, which depends on both Re and the relative roughness (Îµ/D) of the duct surface. For laminar flow (Re < 2300), f = 64/Re regardless of roughness. This distinction matters for HVAC design - galvanized steel, flexible duct, and fiberglass-lined duct all have different roughness values.',
      distractorExplanations: {
    ...
    // â”€â”€ CRANE â”€â”€
    {
      ...
      options: [
        'The restoring moment from crane weight must exceed the overturning moment from the load',
        'The crane must always be heavier than the load it is lifting at any radius',
        'The boom angle must always exceed 45 degrees to prevent forward tipping',
        'The load must be centered directly over the crane\'s center of gravity at all times',
      ],
      correctIndex: 0,
      explanation: 'Stability is a moment balance about the tipping edge (front axle or outrigger). The crane\'s own weight creates a restoring moment, while the lifted load creates an overturning moment = W_load Ã— d_horizontal. This is why cranes have load charts - maximum load decreases as boom reach (horizontal distance) increases. Counterweights increase the restoring moment.',
      distractorExplanations: {
    ...
    // â”€â”€ DAM â”€â”€
    {
      ...
      options: [
        'Triangular - zero at surface, maximum at base. Resultant acts at H/3 from the base.',
        'Uniform - equal pressure at all depths. Resultant acts at mid-height of the dam.',
        'Parabolic - maximum at mid-depth. Resultant acts at H/2 from the base of the dam.',
        'Triangular - maximum at surface. Resultant acts at 2H/3 from the base of the dam.',
      ],
      correctIndex: 0,
      explanation: 'Pressure P = Ïgh increases linearly from zero at the surface to ÏgH at the base, forming a triangle. The resultant of a triangular distribution acts at the centroid: 1/3 from the base (or 2/3 from the surface). For a dam of height H and width w, the total force = Â½ÏgHÂ² Ã— w, acting at H/3 from the bottom.',
      distractorExplanations: {
    ...
    },
    {
      ...
      options: [
        'Hydrostatic pressure is greatest at the base, requiring more mass to resist overturning and sliding',
        'The thick base is purely for architectural appearance and construction tradition',
        'Water pressure is uniform with depth, but the base must support the dam\'s own weight',
        'The thick base only prevents water from seeping and flowing under the dam foundation',
      ],
      correctIndex: 0,
      explanation: 'Hydrostatic pressure increases linearly with depth (P = Ïgh), so the base experiences the highest lateral force. The dam must resist both overturning (moment about the toe) and sliding. A wide, heavy base increases the restoring moment and the friction force (f = Î¼N = Î¼ Ã— weight), providing stability. The triangular cross-section efficiently places mass where it is most needed.',
      distractorExplanations: {
    ...
    {
      id: 'htw-L6-Q17',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="10" y="35" width="5" height="25" fill="#334155" stroke="#334155" stroke-width="1"/><rect x="15" y="35" width="18" height="25" fill="#58CC02" opacity="0.1"/><text x="24" y="50" text-anchor="middle" font-size="3.5" fill="#58CC02">H</text><text x="24" y="68" text-anchor="middle" font-size="3" fill="#334155">F = Â½ÏgHÂ²</text><rect x="45" y="15" width="5" height="50" fill="#334155" stroke="#334155" stroke-width="1"/><rect x="50" y="15" width="25" height="50" fill="#A5E86C" opacity="0.1"/><text x="62" y="42" text-anchor="middle" font-size="3.5" fill="#A5E86C">2H</text><text x="62" y="72" text-anchor="middle" font-size="3" fill="#A5E86C" font-weight="bold">F = 4Ã— !</text><text x="40" y="10" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Force âˆ HÂ²</text></svg>`,
      type: 'true-false',
      question: 'The total hydrostatic force on a dam doubles when the water depth doubles.',
      correctAnswer: false,
      explanation: 'The total hydrostatic force on a vertical surface = Â½ÏgHÂ²w (per unit width). Since force scales with HÂ², doubling the depth quadruples the total force. This square relationship is why dam design becomes dramatically more challenging as reservoir depth increases - a dam holding back 100 m of water faces four times the force of one holding 50 m.',
      distractorExplanations: {
        0: 'The total hydrostatic force on a vertical surface = Â½ÏgHÂ²w (per unit width).',
      },
    },
    // â”€â”€ ESCALATOR / CONVEYOR â”€â”€
    {
      id: 'htw-L6-Q18',
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><line x1="15" y1="65" x2="65" y2="20" stroke="#3B8700" stroke-width="2"/><line x1="15" y1="65" x2="65" y2="65" stroke="#334155" stroke-width="0.5" stroke-dasharray="2 2"/><line x1="65" y1="20" x2="65" y2="65" stroke="#334155" stroke-width="0.5" stroke-dasharray="2 2"/><text x="68" y="44" font-size="3.5" fill="#334155">10m</text><text x="40" y="72" font-size="3" fill="#334155">30Â°</text><path d="M25 55 Q20 58 18 62" stroke="#334155" stroke-width="0.5"/><circle cx="30" cy="52" r="2" fill="#58CC02" opacity="0.5"><animateMotion dur="3s" repeatCount="indefinite" path="M0,0 L25,-22"/></circle><circle cx="40" cy="42" r="2" fill="#58CC02" opacity="0.5"><animateMotion dur="3s" repeatCount="indefinite" path="M0,0 L25,-22"/></circle><circle cx="50" cy="32" r="2" fill="#58CC02" opacity="0.5"><animateMotion dur="3s" repeatCount="indefinite" path="M0,0 L25,-22"/></circle><text x="20" y="48" font-size="3" fill="#58CC02">v=0.5 m/s</text><text x="40" y="12" text-anchor="middle" font-size="4.5" fill="#334155" font-weight="bold">Escalator Power</text><text x="40" y="78" text-anchor="middle" font-size="3" fill="#334155" font-style="italic">P = mg Ã— v Ã— sin30Â° â‰ˆ 5.5 kW</text></svg>`,
      type: 'multiple-choice',
      question: 'An escalator carries 30 passengers (average 75 kg each) up a vertical rise of 10 m. The belt moves at 0.5 m/s along the incline at 30Â°. What minimum motor power is needed, ignoring friction and efficiency losses?',
      options: [
        'About 5.5 kW - P = total weight Ã— vertical velocity component',
        'About 110 kW - must also account for the mass of the stair steps',
        'About 1.1 kW - only the horizontal velocity component matters',
        'About 11 kW - P equals total weight times full belt speed',
      ],
      correctIndex: 0,
      explanation: 'Power = rate of potential energy gain = total mass Ã— g Ã— vertical velocity. The vertical component of belt speed = 0.5 Ã— sin(30Â°) = 0.25 m/s. So P = 30 Ã— 75 Ã— 9.81 Ã— 0.25 â‰ˆ 5,520 W â‰ˆ 5.5 kW. The actual motor must be larger to account for friction, step chain weight, and efficiency (typically 3-5Ã— the theoretical minimum).',
      distractorExplanations: {
    ...
    },
    {
      ...
      options: [
        '12.75 kW - useful output = rated input power times efficiency',
        '17.65 kW - divide by efficiency because the motor compensates for loss',
        '15 kW - efficiency does not reduce the mechanical output power',
        '12.75 kW at startup only; at steady state the output reaches 15 kW',
      ],
      correctIndex: 0,
      explanation: 'Motor efficiency Î· = P_output / P_input. If the motor consumes 15 kW (electrical input) at 85% efficiency, the useful mechanical output = 15 Ã— 0.85 = 12.75 kW. The remaining 2.25 kW is lost as heat. This is why real systems always require motors rated higher than the theoretical load - you must account for efficiency losses in the motor, gearbox, and drivetrain.',
      distractorExplanations: {
