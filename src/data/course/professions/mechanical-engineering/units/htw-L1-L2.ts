  ...
  questions: [
    {
      id: 'htw-L1-T1',
      type: 'teaching',
      question: 'Engineering in the kitchen',
      explanation: 'Every kitchen appliance uses core engineering principles: thermodynamics in your pressure cooker, fluid mechanics in your faucet, and stress analysis in your knife. Understanding these connections makes abstract theory tangible.',
      hint: 'Look at everyday objects through an engineer\'s eyes.',
    },
    {
      id: 'htw-L1-T2',
      type: 'teaching',
      question: 'Pressure and temperature',
      explanation: 'Higher pressure raises the boiling point of water (Clausius-Clapeyron relation). A pressure cooker exploits this to cook food faster at temperatures above 100 C.',
      hint: 'At 2 atm, water boils at about 120 C instead of 100 C.',
    },
    // --- PRESSURE COOKER (Q1-Q4) ---
    {
      ...
      distractorExplanations: {
        1: 'This focuses on sealed/traps, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on steam/molecules, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on thick/walls, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q2',
    ...
    },
    {
      ...
      distractorExplanations: {
        0: 'This focuses on equal, which is not the correct mechanism or principle for this problem.',
        2: 'Regarding axial stress: For a thin-walled pressure vessel, hoop stress = pR/t and axial stress = pR/(2t).',
        3: 'This focuses on three/times, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q4',
      ...
      distractorExplanations: {
        1: 'A dead-weight relief valve opens when pressure \u00D7 seat area > weight force.',
      },
    },
    ...
    // --- REFRIGERATOR (Q5-Q8) ---
    {
      ...
      distractorExplanations: {
        0: 'This focuses on behind/refrigerator, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on compressor, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on condenser/coils, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q6',
      ...
      options: [
        'It converts 4 kW of electricity into 4 kW of cooling output',
        'For every 1 kW of work input, it removes 4 kW of heat',
        'It operates at 400% of the theoretical Carnot limit',
        'It rejects 4 times more heat than it absorbs from inside',
      ],
      ...
      distractorExplanations: {
        0: 'This focuses on converts/electricity, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on operates/theoretical, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on rejects/times, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q7',
    ...
    },
    {
      ...
      distractorExplanations: {
        1: 'The compressor takes in low-pressure superheated vapor (to avoid liquid slugging) and compresses it to high-pressure superheated vapor.',
      },
    },
    ...
    // --- FAUCET/TAP (Q9-Q11) ---
    {
      ...
      options: [
        'Increasing the water pressure inside the faucet body to force air in',
        'Using venturi-effect pressure drop to entrain surrounding air',
        'Heating the water to reduce its viscosity and add volume',
        'Creating turbulence that increases the overall flow rate',
      ],
      ...
      distractorExplanations: {
        0: 'This focuses on increasing/water, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on heating/water, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on creating/turbulence, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q10',
      ...
      distractorExplanations: {
        ...
        2: 'This focuses on diameter/upstream, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on supply/decreases, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q11',
    ...
    // --- KITCHEN KNIFE (Q12-Q14) ---
    {
      ...
      options: [
        'The sharp knife is made of a harder grade of steel',
        'The thin edge concentrates force over a tiny area, creating high stress',
        'The sharp blade has a significantly lower friction coefficient',
      ...
      distractorExplanations: {
        0: 'This focuses on sharp/knife, which is not the correct mechanism or principle for this problem.',
        2: 'Friction is not the governing mechanism here; the correct answer involves a different physical principle.',
        3: 'This focuses on sharp/vibrates, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q13',
      ...
      distractorExplanations: {
        1: 'Ceramic blades (typically zirconia, ZrO\u2082) have Vickers hardness around 1200 HV vs.',
      },
    },
    {
      id: 'htw-L1-Q14',
      ...
      distractorExplanations: {
        0: 'This focuses on axial/tension, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on torsional/shear, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on bending/moments, which is not the correct mechanism or principle for this problem.',
      },
    },
    ...
    // --- MICROWAVE (Q15-Q17) ---
    {
      ...
      distractorExplanations: {
        0: 'This focuses on infrared/radiation, which is not the correct mechanism or principle for this problem.',
        1: 'This focuses on convection/currents, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on conduction/heated, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q16',
      ...
      distractorExplanations: {
        1: 'The microwave cavity dimensions create standing wave patterns with fixed nodes and antinodes.',
      },
    },
    {
      id: 'htw-L1-Q17',
    ...
    // --- POT/PAN ON STOVE (Q18-Q20) ---
    {
      ...
      options: [
        'Copper has a higher melting point, allowing hotter cooking temperatures',
        'Copper has much higher thermal conductivity, spreading heat laterally across the base',
        'Copper is lighter, allowing faster heat absorption from the burner',
        'Copper has higher specific heat capacity, storing more thermal energy',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><text x="22" y="12" text-anchor="middle" font-size="3.5" fill="#334155" font-weight="bold">Steel</text><rect x="8" y="15" width="28" height="6" rx="1" stroke="#3B8700" stroke-width="1.5" fill="#6B7280" fill-opacity="0.15"/><circle cx="22" cy="26" r="3" fill="#58CC02" fill-opacity="0.5"/><text x="22" y="28" text-anchor="middle" font-size="2.5" fill="#334155">hot</text><circle cx="12" cy="17" r="2" fill="#58CC02" fill-opacity="0.1"/><circle cx="32" cy="17" r="2" fill="#58CC02" fill-opacity="0.1"/><text x="22" y="36" text-anchor="middle" font-size="3" fill="#6B7280">kâ‰ˆ15</text><text x="58" y="12" text-anchor="middle" font-size="3.5" fill="#334155" font-weight="bold">Copper</text><rect x="44" y="15" width="28" height="6" rx="1" stroke="#3B8700" stroke-width="1.5" fill="#58CC02" fill-opacity="0.2"/><circle cx="58" cy="26" r="3" fill="#58CC02" fill-opacity="0.5"/><text x="58" y="28" text-anchor="middle" font-size="2.5" fill="#334155">hot</text><circle cx="48" cy="17" r="2" fill="#58CC02" fill-opacity="0.4"><animate attributeName="fill-opacity" values="0.1;0.4;0.1" dur="2s" repeatCount="indefinite"/></circle><circle cx="68" cy="17" r="2" fill="#58CC02" fill-opacity="0.4"><animate attributeName="fill-opacity" values="0.1;0.4;0.1" dur="2s" repeatCount="indefinite"/></circle><line x1="58" y1="18" x2="48" y2="18" stroke="#58CC02" stroke-width="1.5" opacity="0.5"/><line x1="58" y1="18" x2="68" y2="18" stroke="#58CC02" stroke-width="1.5" opacity="0.5"/><text x="58" y="36" text-anchor="middle" font-size="3" fill="#6B7280">kâ‰ˆ400</text><text x="40" y="50" text-anchor="middle" font-size="4" fill="#334155">Lateral heat spreading</text><text x="40" y="58" text-anchor="middle" font-size="3.5" fill="#6B7280">Cu spreads 25Ã— better</text></svg>`,
      correctIndex: 1,
      ...
      distractorExplanations: {
        0: 'Temperature is not the primary factor in this problem; the correct analysis uses a different variable.',
        2: 'This focuses on lighter,/allowing, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on specific/capacity,, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q19',
      ...
      distractorExplanations: {
        0: 'This focuses on conduction/between, which is not the correct mechanism or principle for this problem.',
        1: 'This focuses on radiation/emitted, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on forced/built-in, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L1-Q20',
      ...
      distractorExplanations: {
        0: 'This focuses on double,/material, which is not the correct mechanism or principle for this problem.',
        1: 'This focuses on same,/difference, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on quadruple,/resistance, which is not the correct mechanism or principle for this problem.',
      },
    },
  ],
};
  ...
  questions: [
    {
      id: 'htw-L2-T1',
      type: 'teaching',
      question: 'How cars use thermodynamics',
      explanation: 'A car engine converts chemical energy (fuel) into mechanical work via the Otto or Diesel cycle. Thermal efficiency is limited by the compression ratio and the second law of thermodynamics.',
      hint: 'Higher compression ratio means higher efficiency, but also higher risk of knock in gasoline engines.',
    },
    {
      id: 'htw-L2-T2',
      type: 'teaching',
      question: 'Vehicle dynamics and forces',
      explanation: 'Acceleration, braking, and cornering all depend on friction between tires and road. The contact patch area equals roughly the vehicle weight divided by tire inflation pressure.',
      hint: 'Weight transfer during braking shifts load to the front wheels, which is why front brakes are larger.',
    },
    // --- ENGINE (Q1-Q4) ---
    {
      id: 'htw-L2-Q1',
      ...
      distractorExplanations: {
        0: 'This focuses on intake/(piston, which is not the correct mechanism or principle for this problem.',
        1: 'This focuses on compression/(piston, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on exhaust/(piston, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L2-Q2',
      ...
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><line x1="15" y1="65" x2="15" y2="8" stroke="#3B8700" stroke-width="1.5"/><line x1="15" y1="65" x2="72" y2="65" stroke="#3B8700" stroke-width="1.5"/><text x="8" y="38" font-size="4" fill="#334155" transform="rotate(-90 8 38)">Î·</text><text x="42" y="74" font-size="4" fill="#334155">r (compression ratio)</text><path d="M20,58 C30,40 45,25 65,16" stroke="#58CC02" stroke-width="2.5" fill="none"/><circle cx="30" cy="44" r="2" fill="#3B8700"/><text x="33" y="43" font-size="3" fill="#6B7280">gas râ‰ˆ10</text><circle cx="48" cy="26" r="2" fill="#3B8700"/><text x="51" y="25" font-size="3" fill="#6B7280">diesel râ‰ˆ18</text><text x="40" y="56" text-anchor="middle" font-size="3.5" fill="#334155" font-style="italic">Î· = 1 âˆ’ 1/r^(Î³âˆ’1)</text></svg>`,
      correctIndex: 1,
      ...
      distractorExplanations: {
        0: 'This focuses on octane/rating, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on engine/displacement, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on number/cylinders, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L2-Q3',
      ...
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="8" y="18" width="28" height="36" rx="3" stroke="#3B8700" stroke-width="1.5" fill="#A5E86C" fill-opacity="0.1"/><text x="22" y="14" text-anchor="middle" font-size="4" fill="#334155" font-weight="bold">Gas</text><rect x="14" y="34" width="16" height="6" rx="1" fill="#334155" fill-opacity="0.4"/><text x="22" y="62" text-anchor="middle" font-size="3.5" fill="#6B7280">r = 8-12</text><text x="22" y="70" text-anchor="middle" font-size="3.5" fill="#58CC02">Î· â‰ˆ 25-35%</text><rect x="44" y="18" width="28" height="36" rx="3" stroke="#3B8700" stroke-width="1.5" fill="#58CC02" fill-opacity="0.1"/><text x="58" y="14" text-anchor="middle" font-size="4" fill="#334155" font-weight="bold">Diesel</text><rect x="50" y="44" width="16" height="6" rx="1" fill="#334155" fill-opacity="0.4"/><text x="58" y="62" text-anchor="middle" font-size="3.5" fill="#6B7280">r = 15-22</text><text x="58" y="70" text-anchor="middle" font-size="3.5" fill="#58CC02">Î· â‰ˆ 35-45%</text><text x="40" y="78" text-anchor="middle" font-size="3.5" fill="#334155">Higher r â†’ higher Î·</text></svg>`,
      correctAnswer: true,
      ...
      distractorExplanations: {
        1: 'Diesel engines compress only air (no fuel to pre-ignite), allowing compression ratios of 15-22:1 vs.',
      },
    },
    {
      id: 'htw-L2-Q4',
    ...
    // --- SUSPENSION (Q5-Q7) ---
    {
      ...
      options: [
        'Support the static weight of the car on each corner',
        'Increase the natural frequency of the suspension system',
        'Dissipate vibrational energy as heat to prevent bouncing',
        'Reduce the effective spring rate to improve ride comfort',
      ],
      ...
      distractorExplanations: {
        0: 'This focuses on support/static, which is not the correct mechanism or principle for this problem.',
        1: 'This focuses on increase/natural, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on reduce/effective, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L2-Q6',
      ...
      options: [
        'The system returns to equilibrium without any oscillation or overshoot',
        'The system oscillates with gradually decreasing amplitude before settling',
        'The system oscillates with constant amplitude indefinitely (no decay)',
        'The system returns to equilibrium as fast as possible with no oscillation',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><line x1="10" y1="40" x2="72" y2="40" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="2 1.5"/><line x1="10" y1="10" x2="10" y2="70" stroke="#3B8700" stroke-width="1.5"/><line x1="10" y1="40" x2="72" y2="40" stroke="#3B8700" stroke-width="1" opacity="0.3"/><text x="6" y="26" font-size="3.5" fill="#334155" transform="rotate(-90 6 26)">x</text><text x="42" y="76" font-size="3.5" fill="#334155">t</text><path d="M10,20 C14,55 18,28 22,48 C26,32 30,44 34,38 C38,41 42,39 46,40 C50,40 54,40 58,40 C62,40 66,40 70,40" stroke="#58CC02" stroke-width="2" fill="none"/><text x="20" y="16" font-size="3.5" fill="#58CC02">Î¶ < 1</text><text x="20" y="10" font-size="3.5" fill="#58CC02" font-weight="bold">underdamped</text><path d="M12,18 C14,19 18,26 22,28" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="1 1" fill="none"/><path d="M12,62 C14,61 18,54 22,52" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="1 1" fill="none"/><text x="52" y="68" font-size="3.5" fill="#6B7280">decaying oscillation</text></svg>`,
      correctIndex: 1,
      ...
      distractorExplanations: {
        0: 'This focuses on returns/equilibrium, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on constant/indefinitely, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on returns/equilibrium, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L2-Q7',
    ...
    // --- BRAKES (Q8-Q10) ---
    {
      ...
      distractorExplanations: {
        0: 'This focuses on destroyed/according, which is not the correct mechanism or principle for this problem.',
        2: 'Pressure alone does not explain the behavior described; the correct mechanism is different.',
        3: 'This focuses on returned/engine, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L2-Q9',
      ...
      distractorExplanations: {
        1: 'Disc brakes have an exposed rotor swept by ambient air on both faces, giving excellent convective heat dissipation.',
      },
    },
    {
      id: 'htw-L2-Q10',
      ...
      distractorExplanations: {
        ...
        2: 'This focuses on wheels/faster, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on larger/contact, which is not the correct mechanism or principle for this problem.',
      },
    },
    ...
    // --- TRANSMISSION (Q11-Q13) ---
    {
      ...
      options: [
        'The engine produces more power when operating in first gear',
        'A small engine gear drives a large output gear, multiplying torque at the cost of',
        'The clutch slips more in first gear, adding torque through friction',
        'First gear bypasses the differential for direct power transfer',
      ],
      ...
      distractorExplanations: {
        0: 'This focuses on produces/power, which is not the correct mechanism or principle for this problem.',
        2: 'Friction is not the governing mechanism here; the correct answer involves a different physical principle.',
        3: 'This focuses on first/bypasses, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L2-Q12',
      ...
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="8" y="24" width="28" height="32" rx="3" stroke="#3B8700" stroke-width="1.5" fill="#A5E86C" fill-opacity="0.1"/><text x="22" y="22" text-anchor="middle" font-size="3.5" fill="#334155" font-weight="bold">Input</text><text x="22" y="38" text-anchor="middle" font-size="4" fill="#58CC02">Ï‰ = 3</text><text x="22" y="46" text-anchor="middle" font-size="4" fill="#3B8700">T = 1</text><rect x="44" y="24" width="28" height="32" rx="3" stroke="#3B8700" stroke-width="1.5" fill="#58CC02" fill-opacity="0.1"/><text x="58" y="22" text-anchor="middle" font-size="3.5" fill="#334155" font-weight="bold">Output</text><text x="58" y="38" text-anchor="middle" font-size="4" fill="#58CC02">Ï‰ = 1</text><text x="58" y="46" text-anchor="middle" font-size="4" fill="#3B8700">T = 3</text><line x1="36" y1="40" x2="44" y2="40" stroke="#3B8700" stroke-width="2" marker-end="url(#ar1)"/><defs><marker id="ar1" markerWidth="4" markerHeight="3" refX="4" refY="1.5" orient="auto"><path fill="#3B8700" d="M0,0 L4,1.5 L0,3Z"/></marker></defs><text x="40" y="64" text-anchor="middle" font-size="4" fill="#334155">Gear ratio 3:1</text><text x="40" y="72" text-anchor="middle" font-size="3.5" fill="#6B7280">P = TÏ‰ conserved</text></svg>`,
    ...
    },
    {
      ...
      distractorExplanations: {
        1: 'A torque converter uses three elements: impeller (pump), turbine, and stator.',
      },
    },
    ...
    // --- TIRES (Q14-Q16) ---
    {
      ...
      options: [
        '20 cm\u00B2 - about the area of a large coin',
        '200 cm\u00B2 - about the area of a postcard',
        '2000 cm\u00B2 - about the area of a newspaper',
        '2 cm\u00B2 - about the area of a fingertip',
      ],
      ...
      distractorExplanations: {
        0: '20 is an order of magnitude too small, likely from a unit conversion error.',
        2: '2000 is an order of magnitude too large, likely from a unit conversion error.',
        3: '2 is far too low, indicating important terms were omitted from the calculation.',
      },
    },
    {
      id: 'htw-L2-Q15',
      ...
      options: [
        ...
        'A water wedge builds faster than the tread can drain it, lifting the tire',
        'Water increases tire temperature via friction, causing the rubber to soften',
        'Water freezes under contact pressure, creating a thin ice layer on the road',
      ],
    ...
    // --- STEERING (Q17-Q18) ---
    {
      ...
      distractorExplanations: {
        0: 'This focuses on electric/motor, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on planetary/reducer, which is not the correct mechanism or principle for this problem.',
    ...
    },
    {
      ...
      options: [
        'Both front wheels turn at exactly the same steering angle',
        'The inner wheel turns more than the outer, sharing a common turn center',
        'The rear wheels also turn slightly to reduce the turning radius',
        'The steering gear ratio changes automatically with vehicle speed',
      ],
      diagram: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80" fill="none"><rect x="1" y="1" width="78" height="78" rx="8" fill="#58CC02" opacity="0.08"/><rect x="20" y="20" width="40" height="40" rx="2" stroke="#3B8700" stroke-width="1" stroke-dasharray="2 2" fill="none"/><circle cx="20" cy="60" r="4" stroke="#3B8700" stroke-width="1.5" fill="none"/><circle cx="60" cy="60" r="4" stroke="#3B8700" stroke-width="1.5" fill="none"/><g transform="rotate(-30 20 20)"><rect x="17" y="17" width="6" height="10" rx="1" stroke="#58CC02" stroke-width="1.5" fill="#58CC02" fill-opacity="0.2"/></g><text x="12" y="16" font-size="3.5" fill="#58CC02">Î¸_in</text><g transform="rotate(-15 60 20)"><rect x="57" y="17" width="6" height="10" rx="1" stroke="#3B8700" stroke-width="1.5" fill="#3B8700" fill-opacity="0.15"/></g><text x="64" y="16" font-size="3.5" fill="#3B8700">Î¸_out</text><circle cx="40" cy="80" r="2" fill="#6B7280" fill-opacity="0.3"/><line x1="20" y1="20" x2="40" y2="78" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="2 1"/><line x1="60" y1="20" x2="40" y2="78" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="2 1"/><line x1="20" y1="60" x2="40" y2="78" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="2 1"/><line x1="60" y1="60" x2="40" y2="78" stroke="#6B7280" stroke-width="0.8" stroke-dasharray="2 1"/><text x="42" y="76" font-size="3" fill="#6B7280">ICR</text><text x="40" y="10" text-anchor="middle" font-size="4" fill="#334155">Î¸_inner > Î¸_outer</text></svg>`,
      correctIndex: 1,
      ...
      distractorExplanations: {
        0: 'This focuses on front/wheels, which is not the correct mechanism or principle for this problem.',
        2: 'This focuses on wheels/slightly, which is not the correct mechanism or principle for this problem.',
        3: 'This focuses on steering/ratio, which is not the correct mechanism or principle for this problem.',
      },
    },
    ...
    // --- EXHAUST (Q19-Q20) ---
    {
      ...
      distractorExplanations: {
        0: 'This focuses on making/manifold, which is not the correct mechanism or principle for this problem.',
        2: 'Temperature is not the primary factor in this problem; the correct analysis uses a different variable.',
        3: 'This focuses on bolting/manifold, which is not the correct mechanism or principle for this problem.',
      },
    },
    {
      id: 'htw-L2-Q20',
      ...
      distractorExplanations: {
        1: 'During the exhaust stroke, the piston pushes burnt gases out against the exhaust system\.',
      },
    },
  ],
};
