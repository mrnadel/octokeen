...
export const financeCourseMeta: Unit[] = [
...

  {
    ...
    lessons: [
      { id: "fin-sec16-u1-L1", title: "The Risk-Return Tradeoff", description: "Higher potential returns come with higher risk.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u1-L2", title: "Measuring Volatility", description: "Standard deviation tells you how bumpy the ride is.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u1-L3", title: "Historical Returns by Asset Class", description: "Stocks, bonds, and cash have very different long-term track records.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u1-L4", title: "Risk Tolerance", description: "Your comfort with volatility depends on personality, goals, and time.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u1-L-conv", title: "Risk Scenarios", description: "Help a friend understand their risk tolerance.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u1-L-speed", title: "Risk & Return Speed Round", description: "Rapid-fire on risk, return, and volatility.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u2",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u2-L1", title: "What Correlation Means", description: "How two investments move in relation to each other.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u2-L2", title: "Diversification Math", description: "Why portfolio risk is less than the average of individual risks.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u2-L3", title: "Asset Class Correlations", description: "Stocks, bonds, and real assets move differently.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u2-L4", title: "Building a Diversified Mix", description: "Combine uncorrelated assets for a smoother ride.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u2-L-conv", title: "Diversification Scenarios", description: "Guide a friend through diversification decisions.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u2-L-speed", title: "Correlation Speed Round", description: "Rapid-fire on correlation and diversification.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u3",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u3-L1", title: "The Efficient Frontier", description: "The curve of optimal portfolios for each risk level.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u3-L2", title: "Risk-Free Asset", description: "Treasury bills and the capital market line.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u3-L3", title: "Optimal Portfolios", description: "No single best portfolio exists, it depends on your risk tolerance.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u3-L4", title: "MPT Limitations", description: "The theory assumes rational investors, but real people aren't always rational.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u3-L-conv", title: "Portfolio Optimization Chat", description: "Help someone understand why their portfolio isn't optimal.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u3-L-speed", title: "MPT Speed Round", description: "Rapid-fire on Modern Portfolio Theory.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u4",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u4-L1", title: "Systematic vs Unsystematic Risk", description: "Some risk you can diversify away, some you can't.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u4-L2", title: "Understanding Beta", description: "Beta tells you how sensitive a stock is to market moves.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u4-L3", title: "The CAPM Formula", description: "Expected return equals risk-free rate plus beta times market premium.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u4-L4", title: "Alpha: Beating the Market", description: "Alpha measures returns beyond what risk explains.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u4-L-conv", title: "Risk Pricing Chat", description: "Explain CAPM concepts to an eager new investor.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u4-L-speed", title: "CAPM & Beta Speed Round", description: "Rapid-fire on beta, alpha, and risk pricing.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u5",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u5-L1", title: "Allocation Drives Returns", description: "Asset allocation explains about 90% of return variation.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u5-L2", title: "Model Portfolios", description: "Conservative, moderate, and aggressive allocation examples.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u5-L3", title: "Strategic vs Tactical", description: "Fixed targets vs adjusting to market conditions.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u5-L4", title: "Target-Date Funds", description: "Set-it-and-forget-it funds that adjust allocation as you age.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u5-L-conv", title: "Allocation Planning Chat", description: "Help someone choose the right allocation for their situation.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u5-L-speed", title: "Allocation Speed Round", description: "Rapid-fire on asset allocation concepts.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u6",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u6-L1", title: "What Factors Are", description: "A factor is a trait that explains why some investments earn more.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u6-L2", title: "Value & Size Factors", description: "Cheap stocks and small companies have historically outperformed.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u6-L3", title: "Momentum & Quality", description: "Recent winners and profitable companies tend to keep performing.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u6-L4", title: "Smart Beta ETFs", description: "Rules-based funds that target specific factors.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u6-L5", title: "Factor Premiums Aren't Guaranteed", description: "Factors can underperform for years before reverting.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u6-L-conv", title: "Factor Investing Chat", description: "Discuss factor investing with a curious colleague.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u6-L-speed", title: "Factor Speed Round", description: "Rapid-fire on investment factors.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u7",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u7-L1", title: "Core-Satellite Approach", description: "Index funds as your core, individual picks as satellites.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u7-L2", title: "Tax-Efficient Placement", description: "Put tax-inefficient assets in tax-advantaged accounts.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u7-L3", title: "International Allocation", description: "How much to invest outside your home country.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u7-L4", title: "How Many Holdings", description: "Diversification benefits diminish after about 30 stocks.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u7-L5", title: "Choosing Your Funds", description: "Total market, S&P 500, international developed, and emerging markets.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u7-L-conv", title: "Portfolio Building Chat", description: "Help someone construct their first real portfolio.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u7-L-speed", title: "Construction Speed Round", description: "Rapid-fire on portfolio construction.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u8",
    title: "Measuring Performance",
    description: "Raw returns don't tell the full story. Learn the metrics that reveal true performance.",
    color: "#A5B4FC",
    icon: "📐",
    sectionIndex: 16,
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u8-L1", title: "Absolute vs Relative Returns", description: "Compare your results to the right benchmark.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u8-L2", title: "Sharpe & Sortino Ratios", description: "Return per unit of risk, the gold standard of performance.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u8-L3", title: "Alpha & Benchmarks", description: "Excess return beyond what risk alone predicts.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u8-L4", title: "Survivorship Bias", description: "Failed funds disappear from the data, making averages look better.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u8-L-conv", title: "Performance Review Chat", description: "Help someone evaluate their portfolio's performance.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u8-L-speed", title: "Performance Speed Round", description: "Rapid-fire on performance metrics.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u9",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u9-L1", title: "Portfolio Drift", description: "Winning assets become overweight over time.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u9-L2", title: "Rebalancing Methods", description: "Calendar-based vs threshold-based rebalancing.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u9-L3", title: "Tax-Smart Rebalancing", description: "Use new contributions and tax-loss harvesting to rebalance cheaply.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u9-L4", title: "Rebalancing Tradeoffs", description: "Rebalancing too often costs more than it helps.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec16-u9-L-conv", title: "Rebalancing Chat", description: "Help someone decide when to rebalance their portfolio.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u9-L-speed", title: "Rebalancing Speed Round", description: "Rapid-fire on portfolio maintenance.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec16-u10",
    ...
    sectionTitle: "Portfolio Theory",
    lessons: [
      { id: "fin-sec16-u10-L1", title: "Young Investor Case", description: "Build a portfolio for a 25-year-old with decades ahead.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u10-L2", title: "Pre-Retiree Case", description: "Adjust allocation for someone 7 years from retirement.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u10-L3", title: "Conservative Retiree Case", description: "Design an income-focused portfolio for retirement.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u10-L4", title: "Windfall Case", description: "Handle a sudden inheritance with smart portfolio decisions.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u10-L5", title: "Common Portfolio Mistakes", description: "Chasing performance, home bias, and over-concentration.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec16-u10-L-conv", title: "Portfolio Planning Chat", description: "Coach someone through a real-world portfolio decision.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec16-u10-L-speed", title: "Portfolio Mastery Speed Round", description: "Final rapid-fire covering all portfolio theory topics.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },

  // ─── Section 17: Security Valuation ─────────────────────────

  {
    id: "fin-sec17-u1", title: "Reading Financial Statements",
    description: "Every company tells its story through 3 financial statements. Learn to read them.",
    color: "#8B5CF6", icon: "📄", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u1-L1", title: "The Balance Sheet", description: "Assets, liabilities, and equity in one snapshot.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u1-L2", title: "The Income Statement", description: "Revenue, expenses, and net income over time.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u1-L3", title: "The Cash Flow Statement", description: "Cash in and out from operations, investing, and financing.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u1-L4", title: "Red Flags in Financials", description: "Warning signs that something is off.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u1-L-conv", title: "Financial Statement Chat", description: "Help someone read a company's financials.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u1-L-speed", title: "Financials Speed Round", description: "Rapid-fire on financial statements.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u2", title: "Valuation Ratios",
    description: "Ratios let you compare companies of any size. Learn the most important ones.",
    color: "#A78BFA", icon: "📊", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u2-L1", title: "P/E Ratio", description: "The most common way to value a stock.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u2-L2", title: "P/B and PEG Ratios", description: "Price-to-book and price-to-earnings-growth.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u2-L3", title: "EV/EBITDA", description: "Enterprise value compared to operating profit.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u2-L4", title: "When to Use Each Ratio", description: "Different ratios work for different industries.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u2-L-conv", title: "Valuation Ratios Chat", description: "Compare two companies using ratios.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u2-L-speed", title: "Ratios Speed Round", description: "Rapid-fire on valuation ratios.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u3", title: "Earnings & Revenue Analysis",
    description: "Revenue is vanity, profit is sanity, cash is reality.",
    color: "#C4B5FD", icon: "💹", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u3-L1", title: "Revenue Growth", description: "Top-line growth and what drives it.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u3-L2", title: "Profit Margins", description: "Gross, operating, and net margins explained.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u3-L3", title: "Earnings Per Share", description: "EPS, diluted EPS, and earnings quality.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u3-L4", title: "Revenue Traps", description: "When revenue growth isn't what it seems.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u3-L-conv", title: "Earnings Analysis Chat", description: "Analyze a company's earnings together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u3-L-speed", title: "Earnings Speed Round", description: "Rapid-fire on earnings and revenue.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u4", title: "Dividend Analysis",
    description: "Dividends are cash profits paid to shareholders. Learn to evaluate dividend stocks.",
    color: "#7C3AED", icon: "💰", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u4-L1", title: "Dividend Yield & Payout", description: "Yield, payout ratio, and what they reveal.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u4-L2", title: "Dividend Growth Model", description: "The Gordon Growth Model for valuing dividend stocks.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u4-L3", title: "Dividend Aristocrats", description: "Companies that have raised dividends for 25+ years.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u4-L4", title: "Dividend Traps", description: "When a high yield signals danger, not opportunity.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u4-L-conv", title: "Dividend Chat", description: "Evaluate a dividend stock with a friend.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u4-L-speed", title: "Dividend Speed Round", description: "Rapid-fire on dividends.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u5", title: "Discounted Cash Flow",
    description: "A dollar today is worth more than a dollar tomorrow. DCF is the gold standard of valuation.",
    color: "#6D28D9", icon: "🧮", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u5-L1", title: "Time Value of Money", description: "Why money today is worth more than money later.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u5-L2", title: "Present Value", description: "Discount future cash flows back to today.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u5-L3", title: "Building a DCF Model", description: "Project cash flows, discount, and sum them up.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u5-L4", title: "Terminal Value & Sensitivity", description: "Small assumption changes create big valuation swings.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u5-L-conv", title: "DCF Chat", description: "Walk through a DCF analysis together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u5-L-speed", title: "DCF Speed Round", description: "Rapid-fire on discounted cash flow.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u6", title: "Bond Valuation Deep Dive",
    description: "Bonds have their own valuation math. Learn yields, duration, and the yield curve.",
    color: "#8B5CF6", icon: "📉", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u6-L1", title: "Yield to Maturity", description: "The bond's true return if held to maturity.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u6-L2", title: "Duration & Convexity", description: "How sensitive bond prices are to rate changes.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u6-L3", title: "The Yield Curve", description: "What yield curve shapes tell us about the economy.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u6-L4", title: "Bond Strategies", description: "Ladders, barbells, and bullets.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u6-L-conv", title: "Bond Valuation Chat", description: "Analyze bond yields together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u6-L-speed", title: "Bond Valuation Speed Round", description: "Rapid-fire on bond math.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u7", title: "Credit & Bond Ratings",
    description: "Rating agencies grade bonds from AAA to D. Learn what the grades mean.",
    color: "#A78BFA", icon: "🏛️", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u7-L1", title: "Rating Scales", description: "Moody's vs S&P and what each grade means.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u7-L2", title: "Investment Grade vs Junk", description: "The line between safe and speculative.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u7-L3", title: "Credit Spreads", description: "What the gap between corporate and Treasury yields tells you.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u7-L4", title: "Rating Agency Limits", description: "Why ratings aren't always reliable.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u7-L-conv", title: "Credit Rating Chat", description: "Discuss bond ratings with a colleague.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u7-L-speed", title: "Credit Speed Round", description: "Rapid-fire on bond ratings.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u8", title: "Value vs Growth Investing",
    description: "Two philosophies for picking stocks. Each has strengths, risks, and famous champions.",
    color: "#C4B5FD", icon: "⚖️", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u8-L1", title: "Value Investing", description: "Buying underpriced companies with a margin of safety.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u8-L2", title: "Growth Investing", description: "Paying up for fast-growing companies.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u8-L3", title: "GARP & Contrarian", description: "Growth at a reasonable price and going against the crowd.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u8-L4", title: "Value Traps & Growth Traps", description: "When cheap or fast-growing stocks are actually dangerous.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u8-L-conv", title: "Investment Style Chat", description: "Compare value and growth approaches.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u8-L-speed", title: "Value vs Growth Speed Round", description: "Rapid-fire on investing styles.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u9", title: "Sector & Industry Analysis",
    description: "Different sectors thrive at different times. Learn to analyze industries systematically.",
    color: "#7C3AED", icon: "🏭", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u9-L1", title: "Cyclical vs Defensive", description: "Some sectors boom in growth, others hold up in recession.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u9-L2", title: "Sector Rotation", description: "Shifting allocation based on the economic cycle.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u9-L3", title: "Competitive Moats", description: "What gives a company a durable advantage.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u9-L4", title: "Industry Life Cycles", description: "Introduction, growth, maturity, and decline.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u9-L5", title: "Porter's Five Forces", description: "A framework for analyzing industry competition.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u9-L-conv", title: "Industry Analysis Chat", description: "Analyze an industry together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u9-L-speed", title: "Sector Speed Round", description: "Rapid-fire on sectors and industries.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec17-u10", title: "Building an Investment Thesis",
    description: "Put it all together. Research, analyze, decide, and know when to sell.",
    color: "#6D28D9", icon: "🎯", sectionIndex: 17, sectionTitle: "Security Valuation",
    lessons: [
      { id: "fin-sec17-u10-L1", title: "The Research Process", description: "From screener to financial statements to thesis.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u10-L2", title: "Position Sizing", description: "How much to invest in any single idea.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u10-L3", title: "When to Sell", description: "Thesis broken, better opportunity, or target reached.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u10-L4", title: "Investment Journal", description: "Document your reasoning to improve over time.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec17-u10-L5", title: "Common Analysis Mistakes", description: "Anchoring, falling in love with a stock, and other traps.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec17-u10-L-conv", title: "Investment Thesis Chat", description: "Build an investment thesis from scratch.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec17-u10-L-speed", title: "Thesis Speed Round", description: "Rapid-fire on the investment process.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },

  // ─── Section 18: Economics & Behavior ───────────────────────

  {
    id: "fin-sec18-u1", title: "How the Economy Works",
    description: "GDP, output, and the circular flow of money through the economy.",
    color: "#EC4899", icon: "🌐", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u1-L1", title: "What GDP Measures", description: "The total output of goods and services.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u1-L2", title: "Components of GDP", description: "Consumption, investment, government, and net exports.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u1-L3", title: "Circular Flow", description: "How money flows between households, firms, and government.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u1-L4", title: "Real vs Nominal GDP", description: "Adjusting for inflation reveals true growth.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u1-L-conv", title: "Economy Chat", description: "Explain GDP to a curious friend.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u1-L-speed", title: "GDP Speed Round", description: "Rapid-fire on economic fundamentals.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u2", title: "Inflation & Deflation",
    description: "Prices move for reasons. Understanding why helps you protect your money.",
    color: "#F472B6", icon: "📈", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u2-L1", title: "How CPI Works", description: "Measuring the cost of a basket of goods.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u2-L2", title: "Types of Inflation", description: "Demand-pull, cost-push, and monetary inflation.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u2-L3", title: "Deflation Danger", description: "Falling prices sound great but can spiral into crisis.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u2-L4", title: "Real vs Nominal Values", description: "Adjust for inflation to see the true picture.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u2-L-conv", title: "Inflation Chat", description: "Help someone understand why prices keep rising.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u2-L-speed", title: "Inflation Speed Round", description: "Rapid-fire on inflation concepts.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u3", title: "The Federal Reserve",
    description: "The Fed controls the money supply and interest rates. Its decisions affect your finances.",
    color: "#F9A8D4", icon: "🏦", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u3-L1", title: "Fed Structure", description: "12 regional banks, Board of Governors, and the FOMC.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u3-L2", title: "The Dual Mandate", description: "Maximum employment and price stability.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u3-L3", title: "Fed Tools", description: "Federal funds rate, open market operations, and QE.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u3-L4", title: "How Fed Decisions Ripple", description: "From rate changes to your mortgage, savings, and stocks.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u3-L-conv", title: "Fed Policy Chat", description: "Discuss a Fed rate decision and its effects.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u3-L-speed", title: "Federal Reserve Speed Round", description: "Rapid-fire on the Fed.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u4", title: "Economic Cycles",
    description: "Economies expand and contract in patterns. Learn to recognize where you are.",
    color: "#DB2777", icon: "🔄", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u4-L1", title: "Four Phases", description: "Expansion, peak, contraction, and trough.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u4-L2", title: "Leading Indicators", description: "Signals that predict where the economy is heading.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u4-L3", title: "What Triggers Recessions", description: "From rate hikes to external shocks.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u4-L4", title: "Your Money Through Cycles", description: "How to adjust your finances at each phase.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u4-L-conv", title: "Economic Cycle Chat", description: "Figure out where we are in the cycle.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u4-L-speed", title: "Cycles Speed Round", description: "Rapid-fire on economic cycles.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u5", title: "Interest Rates & You",
    description: "Interest rates touch every part of your financial life.",
    color: "#BE185D", icon: "📍", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u5-L1", title: "Rates and Borrowing", description: "How rate changes affect your mortgage and loans.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u5-L2", title: "Rates and Saving", description: "Higher rates mean more interest on your savings.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u5-L3", title: "Rates and Investments", description: "How rates affect stock and bond prices.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u5-L4", title: "The Yield Curve", description: "What normal, flat, and inverted curves signal.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u5-L-conv", title: "Interest Rate Chat", description: "Discuss a rate change and its personal effects.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u5-L-speed", title: "Rates Speed Round", description: "Rapid-fire on interest rates.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u6", title: "Your Brain on Money",
    description: "Your brain uses shortcuts that worked for survival but fail with money decisions.",
    color: "#EC4899", icon: "🧠", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u6-L1", title: "Loss Aversion", description: "Losses hurt twice as much as gains feel good.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u6-L2", title: "Anchoring & Mental Accounting", description: "First numbers bias you. Money categories trick you.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u6-L3", title: "Sunk Cost & Endowment", description: "Don't keep spending just because you already spent.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u6-L4", title: "Status Quo Bias", description: "The default option wins even when change is better.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u6-L-conv", title: "Bias Scenarios Chat", description: "Spot the biases in real money decisions.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u6-L-speed", title: "Brain Biases Speed Round", description: "Rapid-fire on behavioral biases.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u7", title: "Cognitive Biases in Investing",
    description: "Professional and amateur investors fall for the same mental traps.",
    color: "#F472B6", icon: "🪤", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u7-L1", title: "Confirmation & Recency", description: "Seeking supporting info and overweighting recent events.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u7-L2", title: "Overconfidence & Herding", description: "Thinking you're special and following the crowd.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u7-L3", title: "Disposition Effect", description: "Selling winners too early and holding losers too long.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u7-L4", title: "Hindsight Bias", description: "Thinking you knew it all along after the fact.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u7-L-conv", title: "Investing Bias Chat", description: "Identify biases in investment decisions.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u7-L-speed", title: "Investing Bias Speed Round", description: "Rapid-fire on cognitive biases.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u8", title: "Market Psychology",
    description: "Fear and greed create predictable patterns in markets.",
    color: "#F9A8D4", icon: "🎭", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u8-L1", title: "Fear & Greed Cycle", description: "How emotions drive market booms and busts.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u8-L2", title: "Anatomy of a Bubble", description: "Five stages from displacement to panic.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u8-L3", title: "Panic Selling & FOMO", description: "Emotional extremes that destroy returns.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u8-L4", title: "The VIX Fear Index", description: "How markets measure expected volatility.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u8-L-conv", title: "Market Psychology Chat", description: "Navigate market emotions together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u8-L-speed", title: "Market Psychology Speed Round", description: "Rapid-fire on market psychology.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u9", title: "Debiasing Your Decisions",
    description: "You can't eliminate biases, but you can build systems that protect you from them.",
    color: "#DB2777", icon: "🛡️", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u9-L1", title: "Pre-Commitment Strategies", description: "Automate investing so emotions can't intervene.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u9-L2", title: "Systematic Rules", description: "Dollar-cost averaging and investment policy statements.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u9-L3", title: "Checklists & Cooling Off", description: "Force rational steps before every financial decision.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u9-L4", title: "Accountability Partners", description: "Someone who challenges your reasoning.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u9-L-conv", title: "Debiasing Chat", description: "Build a system to protect against your own biases.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u9-L-speed", title: "Debiasing Speed Round", description: "Rapid-fire on bias-proofing strategies.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec18-u10", title: "Fiscal Policy & Global Economy",
    description: "Government spending, trade, and currencies affect your portfolio.",
    color: "#BE185D", icon: "🌍", sectionIndex: 18, sectionTitle: "Economics & Behavior",
    lessons: [
      { id: "fin-sec18-u10-L1", title: "Fiscal Policy Basics", description: "Government spending and taxation as economic tools.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u10-L2", title: "National Debt & Deficits", description: "What government borrowing means for the economy.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec18-u10-L3", title: "Trade & Currency", description: "How trade balances and exchange rates work.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u10-L4", title: "Global Events & Your Portfolio", description: "Supply chain shocks, geopolitics, and international risks.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec18-u10-L-conv", title: "Global Economy Chat", description: "Discuss how world events affect your investments.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec18-u10-L-speed", title: "Global Economy Speed Round", description: "Rapid-fire on fiscal policy and global markets.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },

  // ─── Section 19: Advanced Strategy ──────────────────────────

  {
    id: "fin-sec19-u1", title: "Tax Bracket Management",
    description: "Optimize your taxes by controlling which bracket your income falls into.",
    color: "#F59E0B", icon: "📋", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u1-L1", title: "Marginal vs Effective Rate", description: "Two different ways to think about your tax rate.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u1-L2", title: "Roth Conversion Ladders", description: "Convert to Roth in low-income years to fill lower brackets.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u1-L3", title: "Income Timing", description: "Defer or accelerate income to stay in a lower bracket.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u1-L4", title: "Tax-Gain Harvesting", description: "Realize capital gains in the 0% bracket.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u1-L5", title: "Bunching Deductions", description: "Alternate standard and itemized deductions across years.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u1-L-conv", title: "Tax Strategy Chat", description: "Help someone optimize their tax bracket.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u1-L-speed", title: "Tax Bracket Speed Round", description: "Rapid-fire on tax optimization.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u2", title: "Charitable Giving Strategy",
    description: "Give smarter, not just more. Strategic giving multiplies impact and tax savings.",
    color: "#FBBF24", icon: "🎁", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u2-L1", title: "Donor-Advised Funds", description: "Contribute now, distribute to charities later.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u2-L2", title: "Donating Appreciated Stock", description: "Avoid capital gains and get the full deduction.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u2-L3", title: "Qualified Charitable Distributions", description: "Donate from your IRA to satisfy RMDs tax-free.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u2-L4", title: "Charitable Remainder Trusts", description: "Income for you now, charity later, tax benefits today.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u2-L-conv", title: "Charitable Giving Chat", description: "Plan a tax-smart charitable strategy.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u2-L-speed", title: "Giving Speed Round", description: "Rapid-fire on charitable strategy.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u3", title: "Trust Fundamentals",
    description: "Trusts aren't just for the wealthy. They're tools for control and protection.",
    color: "#FCD34D", icon: "🏛️", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u3-L1", title: "What a Trust Is", description: "A legal entity that holds assets for beneficiaries.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u3-L2", title: "Revocable Trusts", description: "Keep control, avoid probate, no tax benefit while alive.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u3-L3", title: "Irrevocable Trusts", description: "Give up control for tax benefits and asset protection.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u3-L4", title: "When Trusts Make Sense", description: "Probate avoidance, incapacity, asset protection, special needs.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u3-L5", title: "Trust Taxation", description: "Trusts hit the top tax bracket fast.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u3-L-conv", title: "Trust Planning Chat", description: "Help someone decide if they need a trust.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u3-L-speed", title: "Trust Speed Round", description: "Rapid-fire on trusts.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u4", title: "Estate Tax Planning",
    description: "The estate tax exemption is high today, but planning still matters.",
    color: "#D97706", icon: "📜", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u4-L1", title: "Estate Tax Exemption", description: "The threshold above which estate taxes apply.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u4-L2", title: "Step-Up in Basis", description: "Heirs inherit at current market value, erasing gains.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u4-L3", title: "Gifting Strategies", description: "Annual exclusion and lifetime transfers.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u4-L4", title: "Portability & GST Tax", description: "Sharing exemptions between spouses and across generations.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u4-L-conv", title: "Estate Planning Chat", description: "Navigate estate tax decisions together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u4-L-speed", title: "Estate Tax Speed Round", description: "Rapid-fire on estate planning.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u5", title: "Equity Compensation",
    description: "Stock options and RSUs can build wealth fast, but the tax traps are real.",
    color: "#B45309", icon: "💎", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u5-L1", title: "ISOs vs NSOs", description: "Two types of stock options with very different tax rules.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u5-L2", title: "RSUs Explained", description: "Restricted stock units taxed as income when they vest.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u5-L3", title: "Vesting & Exercise Strategy", description: "When to exercise and how to minimize tax.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u5-L4", title: "Concentration Risk", description: "Too much of your wealth in one company's stock is dangerous.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u5-L-conv", title: "Equity Comp Chat", description: "Help someone navigate their stock option grant.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u5-L-speed", title: "Equity Comp Speed Round", description: "Rapid-fire on stock options and RSUs.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u6", title: "Business Entity Strategy",
    description: "Your business structure determines how much tax you pay. Choose wisely.",
    color: "#F59E0B", icon: "🏢", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u6-L1", title: "Sole Proprietorship & LLC", description: "Simplest structures and their trade-offs.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u6-L2", title: "S-Corp Election", description: "Save self-employment tax with reasonable salary.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u6-L3", title: "C-Corp Basics", description: "Lower corporate rate but double taxation.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u6-L4", title: "QBI Deduction", description: "20% deduction on pass-through income with limits.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u6-L-conv", title: "Entity Selection Chat", description: "Help a business owner choose the right structure.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u6-L-speed", title: "Entity Speed Round", description: "Rapid-fire on business structures.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u7", title: "Real Estate Tax Strategy",
    description: "Real estate has more tax advantages than almost any other investment.",
    color: "#FBBF24", icon: "🏠", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u7-L1", title: "1031 Exchanges", description: "Swap properties and defer all capital gains.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u7-L2", title: "Depreciation & Cost Segregation", description: "Deduct property costs even while it appreciates.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u7-L3", title: "Passive Loss Rules", description: "How rental losses offset income, with limits.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u7-L4", title: "RE Professional Status", description: "Unlimited loss deductions if you qualify.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u7-L-conv", title: "RE Tax Strategy Chat", description: "Plan a tax-efficient real estate investment.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u7-L-speed", title: "RE Tax Speed Round", description: "Rapid-fire on real estate tax strategies.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u8", title: "Social Security Optimization",
    description: "When you claim can change your lifetime benefits by hundreds of thousands.",
    color: "#FCD34D", icon: "🧓", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u8-L1", title: "Claiming Ages", description: "62, 67, or 70: each choice has major consequences.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u8-L2", title: "Spousal & Survivor Benefits", description: "Benefits based on your spouse's record.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u8-L3", title: "Working While Claiming", description: "The earnings test before full retirement age.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u8-L4", title: "Break-Even Analysis", description: "When does waiting to claim start paying off?", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u8-L-conv", title: "SS Optimization Chat", description: "Help someone decide when to claim.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u8-L-speed", title: "Social Security Speed Round", description: "Rapid-fire on Social Security.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u9", title: "Comprehensive Financial Planning",
    description: "A financial plan ties everything together into a roadmap for your life.",
    color: "#D97706", icon: "🗺️", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u9-L1", title: "Needs Analysis Framework", description: "Insurance, retirement, estate, tax, and investment needs.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u9-L2", title: "Goal Prioritization", description: "When you can't do everything, tackle the right things first.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u9-L3", title: "Cash Flow Projections", description: "Model income and expenses over decades.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u9-L4", title: "Monte Carlo & Scenarios", description: "Test your plan against thousands of possible futures.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u9-L5", title: "Hiring a Financial Planner", description: "CFP credential, fee-only vs commission, and red flags.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u9-L-conv", title: "Financial Plan Chat", description: "Build a comprehensive financial plan together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u9-L-speed", title: "Planning Speed Round", description: "Rapid-fire on financial planning.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
  {
    id: "fin-sec19-u10", title: "Derivatives & Alternatives",
    description: "Options, REITs, and other investments beyond stocks and bonds.",
    color: "#B45309", icon: "🔮", sectionIndex: 19, sectionTitle: "Advanced Strategy",
    lessons: [
      { id: "fin-sec19-u10-L1", title: "Call & Put Options", description: "The right to buy or sell at a set price.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u10-L2", title: "Covered Calls", description: "Sell calls on stock you own for income.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u10-L3", title: "REITs & Commodities", description: "Real estate trusts and raw materials as investments.", icon: "📝", xpReward: 20, questions: [] },
      { id: "fin-sec19-u10-L4", title: "Private Equity & Hedge Funds", description: "Advanced vehicles for accredited investors.", icon: "📝", xpReward: 25, questions: [] },
      { id: "fin-sec19-u10-L-conv", title: "Alternatives Chat", description: "Explore alternative investments together.", icon: "💬", type: "conversation", xpReward: 20, questions: [] },
      { id: "fin-sec19-u10-L-speed", title: "Alternatives Speed Round", description: "Rapid-fire on derivatives and alternatives.", icon: "⚡", type: "speed-round", xpReward: 20, questions: [] },
    ],
  },
];
