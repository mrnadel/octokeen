...
export const unit8: Unit = {
 ...
 explanation: "Imagine sending money to a friend without a bank, PayPal, or Venmo in the middle. That's cryptocurrency in a nutshell.",
 ...
 distractorExplanations: {
   0: 'The core difference is decentralization',
 ...
 distractorExplanations: {
   0: 'This is crypto at its most useful. Carlos can receive money cheaply and quickly from family abroad AND store value in an asset that isn\'t tied to h...',
 ...
 explanation: "Imagine a Google Doc that everyone can read, nobody can edit past entries, and new entries are added every 10 minutes. That's basically a blockchain.",
 ...
 id: "pf-u8-L2-T2",
 type: "teaching",
 question: "Who Verifies the Transactions?",
 explanation: "In the traditional system, your bank verifies that you have $50 before letting you send it. In blockchain, thousands of computers around the world do that job.",
 ...
 distractorExplanations: {
   0: 'Each block\'s hash depends on the previous block',
 ...
 distractorExplanations: {
   0: '21 million Bitcoin will ever exist',
 ...
 distractorExplanations: {
   0: 'Bitcoin is divisible to 8 decimal places',
 ...
 explanation: "If Bitcoin is digital gold, Ethereum is digital real estate, you can build things on it. Created by Vitalik Buterin in 2015, Ethereum introduced 'smart contracts': programs that run automatically on the blockchain.",
 ...
 explanation: "Every action on Ethereum costs 'gas', a fee paid in ETH to the validators who process your transaction. It's like paying a toll on a highway.",
 ...
 distractorExplanations: {
   0: 'Bitcoin was designed as peer-to-peer money',
 ...
 distractorExplanations: {
   0: 'Layer 2 networks like Arbitrum or Optimism process transactions off the main Ethereum chain, then batch them together',
 ...
 explanation: "Any cryptocurrency that isn't Bitcoin is called an 'altcoin' (alternative coin). There are over 20,000 of them.",
 ...
 distractorExplanations: {
   0: 'Red flags everywhere: (1) Influencer pump',
 ...
 explanation: "When you buy crypto on an exchange like Coinbase, the exchange holds your crypto for you, kind of like a bank. But unlike a bank, if the exchange gets hacked or goes bankrupt (hello, FTX), your money might vanish.",
 ...
 distractorExplanations: {
   0: 'Large holdings belong in cold storage (virtually unhackable)',
 ...
 distractorExplanations: {
   0: 'The vast majority of lost Bitcoin comes from people who lost their private keys, early adopters who threw away hard drives, forgot passwords, or di...',
 ...
 distractorExplanations: {
   0: 'For beginners, a regulated CEX like Coinbase is safest, but use the Advanced interface to save on fees (0.6% vs 1.5%)',
 ...
 id: "pf-u8-L8-T2",
 type: "teaching",
 question: "DeFi Risks: It's Not All Upside",
 explanation: "DeFi sounds amazing, but it comes with serious risks. Smart contract bugs can be exploited (billions have been stolen from DeFi hacks).",
 ...
 distractorExplanations: {
   0: 'Red flag bingo: brand new protocol, anonymous team, no audit, impossibly high APY',
 ...
 distractorExplanations: {
   0: 'While all are valid use cases, giving financial access to 1.4 billion unbanked people worldwide is DeFi\'s most transformative potential',
 ...
 id: "pf-u8-L9-T1",
 type: "teaching",
 question: "What's an NFT, Actually?",
 explanation: "NFT stands for Non-Fungible Token. 'Non-fungible' just means unique, unlike Bitcoin where every coin is identical, each NFT is one-of-a-kind.",
 ...
 explanation: "In 2021, people paid millions for NFT artwork. A Bored Ape cost $300,000+.",
 ...
 distractorExplanations: {
   0: 'Every red flag is waving: anonymous team, AI-generated art, artificial hype from bots, and guaranteed price promises',
 ...
 distractorExplanations: {
   0: 'You held for 8 months (less than 1 year), so it\'s short-term capital gains, taxed at your regular income rate',
 ...
 distractorExplanations: {
   0: 'For most people, simply holding longer than one year is the biggest tax saver',
 ...
 distractorExplanations: {
   0: 'If you invested money you can afford to lose and have a 10+ year time horizon, a 25% dip is noise',
 ...
 explanation: "If you decide crypto belongs in your portfolio, here's the smart approach: 1) Start with Bitcoin (60-70% of your crypto allocation), it's the most established. 2) Add Ethereum (20-30%), the #2 with real utility.",
 ...
 distractorExplanations: {
   0: 'Jamie has good financial fundamentals, so crypto makes sense, but 25% is way too aggressive, and unresearched altcoins are high-risk',
