      ...
      questions: [
        {
          ...
          explanation: "Insurance is basically a group of people pooling money together so no single person gets destroyed by a disaster. You pay a small, predictable amount (your premium) every month. In exchange, the insurance company covers you if something expensive and terrible happens — a car crash, a hospital stay, a house fire. You're trading a guaranteed small loss for protection against a catastrophic one.",
          options: [
            "Insurance = pooling risk across many people",
            "You pay a small premium to avoid potentially huge costs",
            "The insurance company bets most people won't need a payout",
          ],
        ...
        },
        {
          ...
          explanation: "Before we dive in, here are the terms that come up everywhere in insurance. Premium: what you pay monthly or annually for coverage. Deductible: what you pay out-of-pocket before insurance kicks in. Claim: when you ask the insurance company to pay for something. Coverage limit: the maximum the insurer will pay. Policy: the contract that spells out all the rules.",
          options: [
            "Premium = your regular payment for the policy",
            "Deductible = what YOU pay before insurance helps",
            "Claim = asking the insurer to pay for a covered event",
            "Coverage limit = the most they'll pay out",
          ],
      ...
      questions: [
        {
          ...
          explanation: "There are a few main types of health plans, and they all balance cost vs. freedom. HMO (Health Maintenance Organization): cheapest premiums, but you MUST use in-network doctors and need referrals to see specialists. PPO (Preferred Provider Organization): higher premiums, but you can see any doctor and don't need referrals. HDHP (High-Deductible Health Plan): lowest premiums, highest deductible, but you can open an HSA (a tax-free savings account for medical expenses).",
          options: [
            "HMO = cheapest, least flexible (need referrals, in-network only)",
            "PPO = more expensive, most flexible (any doctor, no referrals)",
            "HDHP = lowest premiums, highest deductible (pairs with HSA)",
          ],
        ...
        },
        {
          ...
          explanation: "An HSA (Health Savings Account) is available only with an HDHP, and it's basically a cheat code. Triple tax advantage: contributions are tax-deductible, money grows tax-free, and withdrawals for medical expenses are tax-free. After age 65, you can withdraw for anything (just pay income tax, like a 401k). The 2024 contribution limit is $4,150 for individuals and $8,300 for families.",
          options: [
            "HSA = triple tax advantage (deduct, grow, withdraw tax-free)",
            "Only available with a High-Deductible Health Plan",
            "After 65, works like a 401(k) for any expense",
      ...
      questions: [
        {
          ...
          explanation: "Every health plan has three key costs that determine what you actually pay. Premium: your monthly bill just to HAVE insurance (you pay this no matter what). Deductible: how much you pay out of pocket each year BEFORE insurance starts covering things. Copay/Coinsurance: what you pay each time you USE a service, even after your deductible is met. These three numbers work together, and understanding them saves you hundreds.",
          options: [
            "Premium = monthly fee to keep your plan active",
            "Deductible = annual out-of-pocket amount before insurance kicks in",
            "Copay = fixed fee per visit (e.g., $25 for a doctor visit)",
            "Coinsurance = your percentage share (e.g., you pay 20%, insurance pays 80%)",
          ],
        ...
        },
        {
          id: "pf-u11-L3-T2",
          type: "teaching",
          question: "⚖️ The Premium-Deductible Seesaw",
          explanation: "Here's the fundamental trade-off in every health plan: high premium = low deductible, and low premium = high deductible. Plan A: $400/month premium, $500 deductible. Plan B: $200/month premium, $3,000 deductible. If you're healthy and rarely use healthcare, Plan B saves you $2,400/year in premiums. But if you have a $5,000 medical event, Plan A saves you $2,500 in deductible costs. Neither is 'better' — it depends on your health and financial situation.",
          options: [
            "High premium + low deductible = pay more monthly, less when sick",
            "Low premium + high deductible = pay less monthly, more when sick",
            "Choose based on how often you actually use healthcare",
          ],
      ...
      questions: [
        {
          ...
          explanation: "Auto insurance isn't one thing — it's a stack of coverages. Liability: pays for damage YOU cause to others (their car, their medical bills). This is legally required in almost every state. Collision: pays to fix YOUR car after an accident (even if it's your fault). Comprehensive: pays for non-accident damage to YOUR car — theft, hail, tree branch, deer strike. Most states only require liability. Collision and comprehensive are optional (but your lender requires them if you have a car loan).",
          options: [
            "Liability = covers damage you cause to OTHER people (required by law)",
            "Collision = covers YOUR car in an accident",
            "Comprehensive = covers YOUR car for non-crash events (theft, weather, animals)",
          ],
        ...
        },
        {
          ...
          explanation: "You'll see auto insurance limits written like '100/300/100.' Here's what those numbers mean. First number ($100K): max payout per PERSON for their injuries. Second number ($300K): max payout per ACCIDENT for all injuries. Third number ($100K): max payout for property damage. So 100/300/100 means up to $100K per injured person, $300K total per accident for injuries, and $100K for their property. Higher limits cost a bit more but protect you much better.",
          options: [
            "First number = bodily injury per person",
            "Second number = bodily injury per accident (total)",
      ...
      questions: [
        {
          ...
          explanation: "Big misconception: your landlord has insurance on the building, but it covers the structure — not your belongings inside it. If there's a fire, flood, or burglary, your laptop, clothes, furniture, and everything you own? That's on you. Renter's insurance covers your personal property, liability (if someone gets hurt in your apartment), and additional living expenses (hotel costs if your place becomes unlivable). And it's shockingly cheap — around $15-25/month.",
          options: [
            "Landlord's insurance covers the building, NOT your stuff",
            "Renter's insurance covers your belongings, liability, and temporary housing",
            "Average cost: just $15-25/month for $30,000+ in coverage",
          ],
        ...
        },
        {
          ...
          explanation: "If you own a home, homeowner's insurance is non-negotiable (your mortgage lender requires it anyway). It covers the structure itself, your personal belongings, liability if someone is injured on your property, and additional living expenses if your home is damaged. Standard policies cover fire, theft, windstorms, and vandalism — but typically NOT floods or earthquakes (those require separate policies).",
          options: [
            "Covers: structure, belongings, liability, temporary housing",
            "Required by mortgage lenders (non-negotiable)",
            "Does NOT cover floods or earthquakes (need separate policies)",
            "Average cost: ~$1,500-2,000/year for a median home",
          ],
      ...
      questions: [
        {
          ...
          explanation: "Life insurance pays your loved ones money when you die. That's it. The question isn't IF you need it — it's WHEN. If someone depends on your income (kids, spouse, aging parents), you need life insurance now. If nobody depends on your income, you probably don't need it yet. There are two main types: Term life (temporary, cheap) and Whole life (permanent, expensive). For 99% of people, term life is the right answer.",
          options: [
            "Life insurance = money for your dependents when you die",
            "Need it if: someone relies on your income",
            "Don't need it if: nobody depends on your income (yet)",
            "Term life = simple and affordable (right for most people)",
          ],
        ...
        },
        {
          ...
          explanation: "Term life: covers you for a set period (10, 20, or 30 years). Cheap because most people don't die during the term. A healthy 30-year-old can get $500K for ~$25/month. Whole life: covers you forever and has a 'cash value' investment component. Sounds great, but it costs 10-15x more than term. A $500K whole life policy might cost $350/month. Most financial experts say: buy term, invest the difference. The cash value in whole life grows slowly and has high fees.",
          options: [
            "Term life: temporary coverage, very affordable (~$25/mo for $500K)",
            "Whole life: permanent coverage, 10-15x more expensive",
            "Expert consensus: buy term + invest the savings yourself",
          ],
      ...
      questions: [
        {
          ...
          explanation: "If you earn $60,000/year and work for 30 more years, your lifetime earnings are $1.8 million. That makes your ability to earn money your single most valuable asset. Disability insurance protects that asset. If an injury or illness prevents you from working, disability insurance replaces a portion of your income (usually 60-70%) so you can still pay your bills. One in four workers will become disabled before retirement age. That's not rare — it's a coin flip.",
          options: [
            "Your income over a career = your biggest financial asset ($1M+)",
            "1 in 4 workers become disabled before age 67",
        ...
        },
        {
          ...
          explanation: "There are two types of disability insurance. Short-term disability (STD): kicks in quickly (within 1-2 weeks), covers you for 3-6 months. Good for recovery from surgery, pregnancy, or temporary injuries. Long-term disability (LTD): kicks in after a waiting period (usually 90 days), covers you for years or until retirement. This is the critical one — it protects you from career-ending disabilities. Many employers offer both. If yours doesn't offer LTD, strongly consider buying your own.",
          options: [
            "Short-term: starts fast, covers 3-6 months (surgery, pregnancy)",
            "Long-term: starts after ~90 days, covers years to retirement",
            "LTD is the more important one — covers catastrophic disability",
            "Check if your employer offers it (many do, and it's cheap)",
          ],
      ...
      questions: [
        {
          ...
          explanation: "The insurance industry makes a fortune selling fear. Not every policy is a good deal. Here are common policies that are usually a waste of money. Extended warranties on electronics (the product rarely breaks, and if it does, replacement is cheap). Credit card insurance (pays your minimum payment if you lose your job — tiny benefit, real cost). Flight insurance (planes are insanely safe, and your life insurance already covers death). Rental car insurance (your auto policy and credit card probably already cover you).",
          options: [
            "Extended warranties: rarely used, high markup",
            "Credit card insurance: tiny benefit for the cost",
            "Flight insurance: planes are the safest transport",
            "Rental car insurance: often duplicate coverage",
          ],
        ...
        },
        {
          ...
          explanation: "Here's the golden rule for deciding when to skip insurance: if you can comfortably absorb the loss, skip the insurance and pocket the premium savings. Insurance is for catastrophic risks you can't afford — not for small, manageable losses. A $200 repair on a $600 phone? Self-insure. A $200,000 surgery? You absolutely need insurance. The line is somewhere around 'Would this loss seriously damage my financial life?' If not, you can skip the coverage.",
          options: [
            "Only insure what you can't afford to lose",
            "Small, predictable losses = self-insure",
            "Catastrophic, unpredictable losses = buy insurance",
            "Extended warranties exist to profit insurance companies, not to help you",
          ],
      ...
      questions: [
        {
          id: "pf-u11-L9-T1",
          type: "teaching",
          question: "🕵️ Identity Theft Is a $10 Billion Industry",
          explanation: "In 2023, Americans lost over $10 billion to fraud. Identity theft is the most common type — someone uses your personal info to open credit cards, file tax returns, or drain bank accounts in your name. The scariest part? You might not know for months until you see mysterious charges, get denied for a loan, or receive an IRS letter about income you never earned. The average victim spends 200+ hours and $1,000+ cleaning up the mess.",
          options: [
            "Americans lost $10+ billion to fraud in 2023",
            "Identity theft = someone uses YOUR info for financial gain",
            "Average victim: 200+ hours and $1,000+ to recover",
            "You might not discover it for months",
          ],
        ...
        },
        {
          ...
          explanation: "A credit freeze is the single most effective thing you can do to prevent identity theft. It locks your credit reports at all three bureaus (Equifax, Experian, TransUnion) so nobody — including you — can open new accounts. When YOU need to apply for credit, you temporarily unfreeze (takes 5 minutes online). It's 100% free by law, doesn't affect your credit score, and stops thieves cold. Everyone should have a credit freeze in place.",
          options: [
            "Credit freeze = locks your credit reports at all 3 bureaus",
            "100% free by law (since 2018)",
            "Doesn't affect your credit score at all",
            "Unfreeze temporarily when YOU need to apply for credit",
            "Stops the #1 type of identity theft: new account fraud",
          ],
      ...
      questions: [
        {
          ...
          explanation: "Most people pick an insurance plan once and never look again. That's how you end up overpaying by hundreds (or thousands) per year. The smart move: shop your insurance every 1-2 years. Get quotes from at least 3 companies. Bundle policies (auto + home/renter's) for 10-25% discounts. Raise your deductible to lower your premium. Ask about every available discount. And never auto-renew without checking if a competitor offers a better deal.",
          options: [
            "Shop every 1-2 years — loyalty rarely pays off",
            "Get at least 3 quotes before deciding",
            "Bundle policies for 10-25% discounts",
            "Raise deductibles to lower premiums (if you have savings)",
            "Ask about EVERY discount — most people miss at least one",
          ],
        ...
        },
        {
          id: "pf-u11-L10-T2",
          type: "teaching",
          question: "🏷️ Discounts You're Probably Missing",
          explanation: "Insurance companies offer tons of discounts but rarely tell you about them. Auto: safe driver, good student, low mileage, bundling, military, paying in full. Home/renter's: security system, smoke detectors, new roof, claims-free. Health: employer contributions, HSA matching, wellness programs. Life: non-smoker, healthy BMI, preferred health rating. You have to ASK for these — they won't just appear on your bill.",
          options: [
            "Auto: safe driver, bundling, low mileage, pay in full",
            "Home: security system, claims-free, new roof discount",
            "Life: non-smoker, healthy weight, preferred health class",
            "Most discounts require you to ASK — they won't volunteer them",
          ],
