    ...
    // ===== LESSON 3: Emergency Fund Blueprint =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          wordBank: ["expenses", "income", "savings", "debt", "wants", "investments"],
    ...
    // ===== LESSON 5: The Savings Automation Trick =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          options: ["Checking account", "Emergency HYSA", "Goals HYSA", "Investment account"],
          matchTargets: ["Daily spending & bills", "Unexpected emergencies only", "Vacation, car, big purchases", "Long-term wealth building"],
          correctMatches: [0, 1, 2, 3],
          explanation: "Each account has one specific job. This separation prevents you from accidentally spending your emergency fund on a vacation or your goal fund on groceries.",
        },
        {
          id: "pf-u2-L5-Q5",
          type: "multiple-choice",
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "Money you lose when an investment drops",
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "Banks offer special challenge accounts",
            "The government gives tax credits for challenges",
          ],
          correctIndex: 0,
    ...
    // ===== LESSON 8: Lifestyle Inflation Trap =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctIndex: 0,
          explanation: "Person A saved 16,000/year × 10 years = 160,000 + investment growth. Person B has 0 saved and is one emergency away from debt. Same income, vastly different outcomes.",
        },
      ],
    },
    ...
    // ===== LESSON 9: Windfalls: Don't Blow the Bonus =====
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correctBuckets: [0, 1, 0, 1, 0, 1],
          explanation: "Paying off debt, boosting savings, and investing create lasting value. Shopping sprees, status purchases, and informal loans with no repayment tend to vanish with nothing to show.",
        },
        {
          id: "pf-u2-L9-Q5",
          type: "match-pairs",
          ...
          matchTargets: ["Pay off credit card first", "Start emergency fund", "Invest for long-term growth", "Add to sinking fund or enjoy"],
          correctMatches: [0, 1, 2, 3],
          explanation: "Priorities: 1) Kill high-interest debt. 2) Build emergency fund. 3) Invest when basics are covered. 4) Enjoy or save for goals when you're in good shape.",
        },
        {
          id: "pf-u2-L9-Q6",
          type: "multiple-choice",
