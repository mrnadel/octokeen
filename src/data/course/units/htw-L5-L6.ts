...
export const lesson5: Lesson = {
  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        'Under load, spokes lose some tension but never go slack — a slack spoke would buckle',
        'Pretension increases the weight capacity of each spoke by making it stronger',
        'It prevents the rim from expanding outward due to centrifugal force at speed',
        'Pretension is only cosmetic — it keeps the wheel round for visual appeal only',
      ],
      correctIndex: 0,
    ...
    // ── TENNIS/BADMINTON RACKET ──
    {
      ...
      options: [
        'The sweet spot is at a vibration node — a node stays stationary, so no impulse reaches the hand',
        'The sweet spot is where the racket frame cross-section is thickest and most rigid',
        'The sweet spot is where string density is highest, creating the maximum hit force',
    ...
    },
    {
      ...
      options: [
        'Much higher specific stiffness, allowing a stiffer yet lighter frame',
        'Carbon fiber is cheaper than wood for mass production runs',
        'Carbon fiber eliminates all vibration during ball impact',
        'Wood cannot be shaped into a proper racket frame geometry',
      ],
      correctIndex: 0,
    ...
    // ── SKATEBOARD / ROLLER COASTER ──
    {
      ...
      options: [
        'Centripetal acceleration must be at least g, i.e. v²/r ≥ g, keeping normal force non-negative',
        'The car must have enough kinetic energy to overcome the loop\'s air resistance',
        'The track must push the car outward, away from the center, at the top',
        'The car\'s weight must exceed the required centripetal force at all speeds',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        'The normal force must provide centripetal acceleration and support weight, so it exceeds mg',
        'Gravity increases at the bottom of any curved surface due to geometry effects',
        'The skateboard deck compresses, adding a spring force to the rider\'s weight',
    ...
    // ── DIVING BOARD ──
    {
      ...
      options: [
        'A cantilever beam — maximum bending stress at the fixed end',
        'A simply supported beam — maximum stress at the center span',
        'A column under compression — maximum stress at mid-height',
        'A truss member — stress distributed uniformly along its length',
      ],
      correctIndex: 0,
    ...
    // ── HELMET ──
    {
      ...
      options: [
        'The foam increases stopping time, reducing peak force per the impulse-momentum theorem',
        'The foam reflects the impact energy back outward like a compressed spring',
        'The foam is stronger than the skull, so it absorbs the entire impact force',
        'The foam prevents the helmet shell from cracking by distributing stress evenly',
      ],
      correctIndex: 0,
    ...
    },
    {
      ...
      options: [
        '2^(1/3) ≈ 1.26 — because power = drag × velocity = Cv³',
        '2 — double power means double speed at steady state',
        '√2 ≈ 1.41 — because drag force scales with v²',
        '4 — because power is proportional to v⁴ for boats',
      ],
      correctIndex: 0,
...
export const lesson6: Lesson = {
  ...
  questions: [
    // ── ELEVATOR ──
    {
      ...
      options: [
        'Elevators run empty more often than full — 40% balances the average load for minimum motor power',
    ...
    },
    {
      ...
      options: [
        '(2000−1500)×g + (2000+1500)×1.5 = 10,155 N — gravity imbalance plus total inertia',
        '2000 × 9.81 = 19,620 N — the full weight of the cab without counterweight',
        '(2000 − 1500) × 9.81 = 4,905 N — only the net gravitational weight difference',
        '2000 × 1.5 = 3,000 N — only the acceleration force acting on the cab',
      ],
      correctIndex: 0,
