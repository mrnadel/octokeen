...
export const shopItems: ShopItem[] = [
  // --------------- Power-ups ---------------
  {
    id: 'shop-heart-refill-1',
    name: 'Refill 1 Heart',
    description: 'Instantly restore 1 heart so you can keep practicing.',
    icon: '❤️',
    cost: 15,
    category: 'power-up',
    type: 'heart_refill',
    metadata: { heartsToRefill: 1 },
  },
  {
  ...
  },
  {
    ...
    description: 'Earn 2x XP on all questions for 30 minutes.',
    icon: '⚡',
    cost: 50,
    category: 'power-up',
    type: 'double_xp',
